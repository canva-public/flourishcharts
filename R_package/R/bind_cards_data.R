...
bind_cards_data <- function(
  ...
  if (!is.null(cards_data)) {
    ...
    columns_cards_data <- columns_cards_data[
      !sapply(columns_cards_data, is.null)
    ]
    ...
    cards_data[, int_columns_cards_data] <- lapply(
      cards_data[, int_columns_cards_data],
      as.character
    )
  }
  ...
  if (!is.null(title_output_format) && !is.null(title_input_format)) {
    if (isTRUE(grepl("^%", title_output_format))) {
      ...
      new_list$x$metadata$cards$title$type_id <- paste0(
        "datetime$",
        title_input_format
      )
      new_list$x$metadata$cards$title$output_format_id <- paste0(
        "datetime$",
        title_output_format
      )
  ...
  if (!is.null(image_output_format) && !is.null(image_input_format)) {
    if (isTRUE(grepl("^%", image_output_format))) {
      ...
      new_list$x$metadata$cards$image$type_id <- paste0(
        "datetime$",
        image_input_format
      )
      new_list$x$metadata$cards$image$output_format_id <- paste0(
        "datetime$",
        image_output_format
      )
  ...
  if (!is.null(category_output_format) && !is.null(category_input_format)) {
    if (isTRUE(grepl("^%", category_output_format))) {
      ...
      new_list$x$metadata$cards$category$type_id <- paste0(
        "datetime$",
        category_input_format
      )
      new_list$x$metadata$cards$category$output_format_id <- paste0(
        "datetime$",
  ...
  if (!is.null(subtitle_output_format) && !is.null(subtitle_input_format)) {
    if (isTRUE(grepl("^%", subtitle_output_format))) {
      ...
      new_list$x$metadata$cards$subtitle$type_id <- paste0(
        "datetime$",
        subtitle_input_format
      )
      new_list$x$metadata$cards$subtitle$output_format_id <- paste0(
        "datetime$",
  ...
  if (!is.null(text_output_format) && !is.null(text_input_format)) {
    if (isTRUE(grepl("^%", text_output_format))) {
      ...
      new_list$x$metadata$cards$text$type_id <- paste0(
        "datetime$",
        text_input_format
      )
      new_list$x$metadata$cards$text$output_format_id <- paste0(
        "datetime$",
        text_output_format
      )
  ...
  if (!is.null(audio_output_format) && !is.null(audio_input_format)) {
    if (isTRUE(grepl("^%", audio_output_format))) {
      ...
      new_list$x$metadata$cards$audio$type_id <- paste0(
        "datetime$",
        audio_input_format
      )
      new_list$x$metadata$cards$audio$output_format_id <- paste0(
        "datetime$",
        audio_output_format
      )
      ...
      isTRUE(
        !is.na(audio_output_format) &&
          isFALSE(grepl("_", audio_output_format)) &&
          isFALSE(grepl("^%", audio_output_format))
      )
    ) {
  ...
  if (!is.null(filter_output_format) && !is.null(filter_input_format)) {
    if (isTRUE(grepl("^%", filter_output_format))) {
      ...
      new_list$x$metadata$cards$filter$type_id <- paste0(
        "datetime$",
        filter_input_format
      )
      new_list$x$metadata$cards$filter$output_format_id <- paste0(
        "datetime$",
  ...
  if (!is.null(metadata_output_format) && !is.null(metadata_input_format)) {
    if (isTRUE(grepl("^%", metadata_output_format))) {
      ...
      new_list$x$metadata$cards$metadata$type_id <- paste0(
        "datetime$",
        metadata_input_format
      )
      new_list$x$metadata$cards$metadata$output_format_id <- paste0(
        "datetime$",
