...
bind_scatter_data <- function(
  ...
  if (!is.null(x_output_format) && !is.null(x_input_format)) {
    if (isTRUE(grepl("^%", x_output_format))) {
      ...
      new_list$x$metadata$data$x$output_format_id <- paste0(
        "datetime$",
        x_output_format
      )
      ...
      isTRUE(
        !is.na(x_output_format) &&
          isFALSE(grepl("_", x_output_format)) &&
          isFALSE(grepl("^%", x_output_format))
      )
    ) {
  ...
  if (!is.null(y_output_format) && !is.null(y_input_format)) {
    if (isTRUE(grepl("^%", y_output_format))) {
      ...
      new_list$x$metadata$data$y$output_format_id <- paste0(
        "datetime$",
        y_output_format
      )
      ...
      isTRUE(
        !is.na(y_output_format) &&
          isFALSE(grepl("_", y_output_format)) &&
          isFALSE(grepl("^%", y_output_format))
      )
    ) {
  ...
  if (!is.null(color_output_format) && !is.null(color_input_format)) {
    if (isTRUE(grepl("^%", color_output_format))) {
      ...
      new_list$x$metadata$data$color$type_id <- paste0(
        "datetime$",
        color_input_format
      )
      new_list$x$metadata$data$color$output_format_id <- paste0(
        "datetime$",
        color_output_format
      )
  ...
  if (!is.null(size_output_format) && !is.null(size_input_format)) {
    if (isTRUE(grepl("^%", size_output_format))) {
      ...
      new_list$x$metadata$data$size$type_id <- paste0(
        "datetime$",
        size_input_format
      )
      new_list$x$metadata$data$size$output_format_id <- paste0(
        "datetime$",
        size_output_format
      )
  ...
  if (!is.null(shape_output_format) && !is.null(shape_input_format)) {
    if (isTRUE(grepl("^%", shape_output_format))) {
      ...
      new_list$x$metadata$data$shape$type_id <- paste0(
        "datetime$",
        shape_input_format
      )
      new_list$x$metadata$data$shape$output_format_id <- paste0(
        "datetime$",
        shape_output_format
      )
      ...
      isTRUE(
        !is.na(shape_output_format) &&
          isFALSE(grepl("_", shape_output_format)) &&
          isFALSE(grepl("^%", shape_output_format))
      )
    ) {
  ...
  if (!is.null(slider_output_format) && !is.null(slider_input_format)) {
    if (isTRUE(grepl("^%", slider_output_format))) {
      ...
      new_list$x$metadata$data$slider$type_id <- paste0(
        "datetime$",
        slider_input_format
      )
      new_list$x$metadata$data$slider$output_format_id <- paste0(
        "datetime$",
        slider_output_format
      )
      ...
      isTRUE(
        !is.na(slider_output_format) &&
          isFALSE(grepl("_", slider_output_format)) &&
          isFALSE(grepl("^%", slider_output_format))
      )
    ) {
  ...
  if (!is.null(series_output_format) && !is.null(series_input_format)) {
    if (isTRUE(grepl("^%", series_output_format))) {
      ...
      new_list$x$metadata$data$series$type_id <- paste0(
        "datetime$",
        series_input_format
      )
      new_list$x$metadata$data$series$output_format_id <- paste0(
        "datetime$",
        series_output_format
      )
      ...
      isTRUE(
        !is.na(series_output_format) &&
          isFALSE(grepl("_", series_output_format)) &&
          isFALSE(grepl("^%", series_output_format))
      )
    ) {
