...
bind_sports_data <- function(
  ...
  if (!is.null(positions_data)) {
    ...
    columns_positions_data <- columns_positions_data[
      !sapply(columns_positions_data, is.null)
    ]
    ...
    positions_data[, int_columns_positions_data] <- lapply(
      positions_data[, int_columns_positions_data],
      as.character
    )
  }
  ...
  if (!is.null(info_output_format) && !is.null(info_input_format)) {
    if (isTRUE(grepl("^%", info_output_format))) {
      ...
      new_list$x$metadata$positions$info$type_id <- paste0(
        "datetime$",
        info_input_format
      )
      new_list$x$metadata$positions$info$output_format_id <- paste0(
        "datetime$",
        info_output_format
      )
      ...
      isTRUE(
        !is.na(info_output_format) &&
          isFALSE(grepl("_", info_output_format)) &&
          isFALSE(grepl("^%", info_output_format))
      )
    ) {
  ...
  if (!is.null(color_output_format) && !is.null(color_input_format)) {
    if (isTRUE(grepl("^%", color_output_format))) {
      ...
      new_list$x$metadata$positions$color$type_id <- paste0(
        "datetime$",
        color_input_format
      )
      new_list$x$metadata$positions$color$output_format_id <- paste0(
        "datetime$",
        color_output_format
      )
      ...
      isTRUE(
        !is.na(color_output_format) &&
          isFALSE(grepl("_", color_output_format)) &&
          isFALSE(grepl("^%", color_output_format))
      )
    ) {
  ...
  if (!is.null(size_output_format) && !is.null(size_input_format)) {
    if (isTRUE(grepl("^%", size_output_format))) {
      ...
      new_list$x$metadata$positions$size$type_id <- paste0(
        "datetime$",
        size_input_format
      )
      new_list$x$metadata$positions$size$output_format_id <- paste0(
        "datetime$",
        size_output_format
      )
      ...
      isTRUE(
        !is.na(size_output_format) &&
          isFALSE(grepl("_", size_output_format)) &&
          isFALSE(grepl("^%", size_output_format))
      )
    ) {
  ...
  if (
    !is.null(squad_number_output_format) && !is.null(squad_number_input_format)
  ) {
    if (isTRUE(grepl("^%", squad_number_output_format))) {
      new_list$x$metadata$positions$squad_number$type <- "datetime"
      new_list$x$metadata$positions$squad_number$type_id <- paste0(
        "datetime$",
        squad_number_input_format
      )
      new_list$x$metadata$positions$squad_number$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(squad_number_output_format) &&
          isFALSE(grepl("_", squad_number_output_format)) &&
          isFALSE(grepl("^%", squad_number_output_format))
      )
    ) {
    ...
    if (
      is.na(squad_number_input_format) && !is.na(squad_number_output_format)
    ) {
  ...
  if (!is.null(position_x_output_format) && !is.null(position_x_input_format)) {
    if (isTRUE(grepl("^%", position_x_output_format))) {
      ...
      new_list$x$metadata$positions$position_x$type_id <- paste0(
        "datetime$",
        position_x_input_format
      )
      new_list$x$metadata$positions$position_x$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(position_x_output_format) &&
          isFALSE(grepl("_", position_x_output_format)) &&
          isFALSE(grepl("^%", position_x_output_format))
      )
    ) {
  ...
  if (!is.null(position_y_output_format) && !is.null(position_y_input_format)) {
    if (isTRUE(grepl("^%", position_y_output_format))) {
      ...
      new_list$x$metadata$positions$position_y$type_id <- paste0(
        "datetime$",
        position_y_input_format
      )
      new_list$x$metadata$positions$position_y$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(position_y_output_format) &&
          isFALSE(grepl("_", position_y_output_format)) &&
          isFALSE(grepl("^%", position_y_output_format))
      )
    ) {
  ...
  if (!is.null(filter_output_format) && !is.null(filter_input_format)) {
    if (isTRUE(grepl("^%", filter_output_format))) {
      ...
      new_list$x$metadata$positions$filter$type_id <- paste0(
        "datetime$",
        filter_input_format
      )
      new_list$x$metadata$positions$filter$output_format_id <- paste0(
        "datetime$",
  ...
  if (!is.null(photo_output_format) && !is.null(photo_input_format)) {
    if (isTRUE(grepl("^%", photo_output_format))) {
      ...
      new_list$x$metadata$positions$photo$type_id <- paste0(
        "datetime$",
        photo_input_format
      )
      new_list$x$metadata$positions$photo$output_format_id <- paste0(
        "datetime$",
        photo_output_format
      )
      ...
      isTRUE(
        !is.na(photo_output_format) &&
          isFALSE(grepl("_", photo_output_format)) &&
          isFALSE(grepl("^%", photo_output_format))
      )
    ) {
  ...
  if (!is.null(metadata_output_format) && !is.null(metadata_input_format)) {
    if (isTRUE(grepl("^%", metadata_output_format))) {
      ...
      new_list$x$metadata$positions$metadata$type_id <- paste0(
        "datetime$",
        metadata_input_format
      )
      new_list$x$metadata$positions$metadata$output_format_id <- paste0(
        "datetime$",
