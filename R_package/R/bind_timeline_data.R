...
bind_timeline_data <- function(
  ...
  if (!is.null(time_start_output_format) && !is.null(time_start_input_format)) {
    if (isTRUE(grepl("^%", time_start_output_format))) {
      ...
      new_list$x$metadata$data$time_start$type_id <- paste0(
        "datetime$",
        time_start_input_format
      )
      new_list$x$metadata$data$time_start$output_format_id <- paste0(
        "datetime$",
        time_start_output_format
      )
      ...
      isTRUE(
        !is.na(time_start_output_format) &&
          isFALSE(grepl("_", time_start_output_format)) &&
          isFALSE(grepl("^%", time_start_output_format))
      )
    ) {
  ...
  if (!is.null(time_end_output_format) && !is.null(time_end_input_format)) {
    if (isTRUE(grepl("^%", time_end_output_format))) {
      ...
      new_list$x$metadata$data$time_end$type_id <- paste0(
        "datetime$",
        time_end_input_format
      )
      new_list$x$metadata$data$time_end$output_format_id <- paste0(
        "datetime$",
        time_end_output_format
      )
      ...
      isTRUE(
        !is.na(time_end_output_format) &&
          isFALSE(grepl("_", time_end_output_format)) &&
          isFALSE(grepl("^%", time_end_output_format))
      )
    ) {
  ...
  if (!is.null(title_output_format) && !is.null(title_input_format)) {
    if (isTRUE(grepl("^%", title_output_format))) {
      ...
      new_list$x$metadata$data$title$type_id <- paste0(
        "datetime$",
        title_input_format
      )
      new_list$x$metadata$data$title$output_format_id <- paste0(
        "datetime$",
        title_output_format
      )
      ...
      isTRUE(
        !is.na(title_output_format) &&
          isFALSE(grepl("_", title_output_format)) &&
          isFALSE(grepl("^%", title_output_format))
      )
    ) {
  ...
  if (!is.null(subtitle_output_format) && !is.null(subtitle_input_format)) {
    if (isTRUE(grepl("^%", subtitle_output_format))) {
      ...
      new_list$x$metadata$data$subtitle$type_id <- paste0(
        "datetime$",
        subtitle_input_format
      )
      new_list$x$metadata$data$subtitle$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(subtitle_output_format) &&
          isFALSE(grepl("_", subtitle_output_format)) &&
          isFALSE(grepl("^%", subtitle_output_format))
      )
    ) {
  ...
  if (!is.null(text_output_format) && !is.null(text_input_format)) {
    if (isTRUE(grepl("^%", text_output_format))) {
      ...
      new_list$x$metadata$data$text$type_id <- paste0(
        "datetime$",
        text_input_format
      )
      new_list$x$metadata$data$text$output_format_id <- paste0(
        "datetime$",
        text_output_format
      )
      ...
      isTRUE(
        !is.na(text_output_format) &&
          isFALSE(grepl("_", text_output_format)) &&
          isFALSE(grepl("^%", text_output_format))
      )
    ) {
  ...
  if (!is.null(background_output_format) && !is.null(background_input_format)) {
    if (isTRUE(grepl("^%", background_output_format))) {
      ...
      new_list$x$metadata$data$background$type_id <- paste0(
        "datetime$",
        background_input_format
      )
      new_list$x$metadata$data$background$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(background_output_format) &&
          isFALSE(grepl("_", background_output_format)) &&
          isFALSE(grepl("^%", background_output_format))
      )
    ) {
