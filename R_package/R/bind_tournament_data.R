...
bind_tournament_data <- function(
  ...
  if (!is.null(matches_data)) {
    ...
    columns_matches_data <- columns_matches_data[
      !sapply(columns_matches_data, is.null)
    ]
    ...
    matches_data[, int_columns_matches_data] <- lapply(
      matches_data[, int_columns_matches_data],
      as.character
    )
  }
  ...
  if (!is.null(round_output_format) && !is.null(round_input_format)) {
    if (isTRUE(grepl("^%", round_output_format))) {
      ...
      new_list$x$metadata$matches$round$type_id <- paste0(
        "datetime$",
        round_input_format
      )
      new_list$x$metadata$matches$round$output_format_id <- paste0(
        "datetime$",
        round_output_format
      )
      ...
      isTRUE(
        !is.na(round_output_format) &&
          isFALSE(grepl("_", round_output_format)) &&
          isFALSE(grepl("^%", round_output_format))
      )
    ) {
  ...
  if (!is.null(team_a_output_format) && !is.null(team_a_input_format)) {
    if (isTRUE(grepl("^%", team_a_output_format))) {
      ...
      new_list$x$metadata$matches$team_a$type_id <- paste0(
        "datetime$",
        team_a_input_format
      )
      new_list$x$metadata$matches$team_a$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(team_a_output_format) &&
          isFALSE(grepl("_", team_a_output_format)) &&
          isFALSE(grepl("^%", team_a_output_format))
      )
    ) {
  ...
  if (!is.null(team_b_output_format) && !is.null(team_b_input_format)) {
    if (isTRUE(grepl("^%", team_b_output_format))) {
      ...
      new_list$x$metadata$matches$team_b$type_id <- paste0(
        "datetime$",
        team_b_input_format
      )
      new_list$x$metadata$matches$team_b$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(team_b_output_format) &&
          isFALSE(grepl("_", team_b_output_format)) &&
          isFALSE(grepl("^%", team_b_output_format))
      )
    ) {
  ...
  if (!is.null(winner_output_format) && !is.null(winner_input_format)) {
    if (isTRUE(grepl("^%", winner_output_format))) {
      ...
      new_list$x$metadata$matches$winner$type_id <- paste0(
        "datetime$",
        winner_input_format
      )
      new_list$x$metadata$matches$winner$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(winner_output_format) &&
          isFALSE(grepl("_", winner_output_format)) &&
          isFALSE(grepl("^%", winner_output_format))
      )
    ) {
  ...
  if (!is.null(score_a_output_format) && !is.null(score_a_input_format)) {
    if (isTRUE(grepl("^%", score_a_output_format))) {
      ...
      new_list$x$metadata$matches$score_a$type_id <- paste0(
        "datetime$",
        score_a_input_format
      )
      new_list$x$metadata$matches$score_a$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(score_a_output_format) &&
          isFALSE(grepl("_", score_a_output_format)) &&
          isFALSE(grepl("^%", score_a_output_format))
      )
    ) {
  ...
  if (!is.null(score_b_output_format) && !is.null(score_b_input_format)) {
    if (isTRUE(grepl("^%", score_b_output_format))) {
      ...
      new_list$x$metadata$matches$score_b$type_id <- paste0(
        "datetime$",
        score_b_input_format
      )
      new_list$x$metadata$matches$score_b$output_format_id <- paste0(
        "datetime$",
      ...
      isTRUE(
        !is.na(score_b_output_format) &&
          isFALSE(grepl("_", score_b_output_format)) &&
          isFALSE(grepl("^%", score_b_output_format))
      )
    ) {
  ...
  if (!is.null(metadata_output_format) && !is.null(metadata_input_format)) {
    if (isTRUE(grepl("^%", metadata_output_format))) {
      ...
      new_list$x$metadata$matches$metadata$type_id <- paste0(
        "datetime$",
        metadata_input_format
      )
      new_list$x$metadata$matches$metadata$output_format_id <- paste0(
        "datetime$",
  ...
  if (!is.null(id_output_format) && !is.null(id_input_format)) {
    if (isTRUE(grepl("^%", id_output_format))) {
      ...
      new_list$x$metadata$teams$id$type_id <- paste0(
        "datetime$",
        id_input_format
      )
      new_list$x$metadata$teams$id$output_format_id <- paste0(
        "datetime$",
        id_output_format
      )
      ...
      isTRUE(
        !is.na(id_output_format) &&
          isFALSE(grepl("_", id_output_format)) &&
          isFALSE(grepl("^%", id_output_format))
      )
    ) {
  ...
  if (!is.null(image_output_format) && !is.null(image_input_format)) {
    if (isTRUE(grepl("^%", image_output_format))) {
      ...
      new_list$x$metadata$teams$image$type_id <- paste0(
        "datetime$",
        image_input_format
      )
      new_list$x$metadata$teams$image$output_format_id <- paste0(
        "datetime$",
        image_output_format
      )
