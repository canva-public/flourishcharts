...
set_bar_chart_race_details <- function(
    ...
    if (!height_mode %in% list_height_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"fill_space": "fill_space", "specified": "specified"}'
        )) >
          1
      ) {
  ...
  if (!is.null(color_mode)) {
    if (!color_mode %in% list_color_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"category": "category", "bar": "bar", "single": "single"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (length(color_single_overrides) > 1) {
    new_list$x$state$color_single_overrides <- paste(
  ...
  if (!is.null(caption_text_align)) {
    if (!caption_text_align %in% list_caption_text_align) {
      stop(
        "`caption_text_align` must be one of: c('flex-start', 'center', 'flex-end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && caption_text_align %in% names(named_list)
        ) {
  ...
  if (!is.null(caption_position)) {
    if (!caption_position %in% list_caption_position) {
      stop(
        "`caption_position` must be one of: c('top-left', 'center-left', 'bottom-left', 'top-right', 'center-right', 'bottom-right', 'top-center', 'center-center', 'bottom-center')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"top-left": "top-left", "center-left": "center-left", "bottom-left": "bottom-left", "top-right": "top-right", "center-right": "center-right", "bottom-right": "bottom-right", "top-center": "top-center", "center-center": "center-center", "bottom-center": "bottom-center"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(caption_mode)) {
    if (!caption_mode %in% list_caption_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"text_legend": "text_legend", "html": "html"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(caption_image_position)) {
    if (!caption_image_position %in% list_caption_image_position) {
      stop(
        "`caption_image_position` must be one of: c('column', 'column-reverse', 'row', 'row-reverse')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"column": "column", "column-reverse": "column-reverse", "row": "row", "row-reverse": "row-reverse"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            caption_image_position %in% names(named_list)
        ) {
  ...
  if (!is.null(scale_type)) {
    if (!scale_type %in% list_scale_type) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "auto_fixed": "auto_fixed", "manual": "manual"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(annotations_enabled)) {
    if (!annotations_enabled %in% list_annotations_enabled) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && annotations_enabled %in% names(named_list)
        ) {
  ...
  if (length(annotations_content) > 1) {
    new_list$x$state$annotations_content <- paste(
      annotations_content,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(annotations_text_weight)) {
    if (!annotations_text_weight %in% list_annotations_text_weight) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            annotations_text_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(annotations_align)) {
    if (!annotations_align %in% list_annotations_align) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && annotations_align %in% names(named_list)
        ) {
  ...
  if (!is.null(annotations_offset)) {
    if (!annotations_offset %in% list_annotations_offset) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && annotations_offset %in% names(named_list)
        ) {
  ...
  if (!is.null(blank_cells)) {
    if (!blank_cells %in% list_blank_cells) {
      stop(
        "`blank_cells` must be one of: c('interpolate', 'last_valid', 'zero', 'remove')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"interpolate": "interpolate", "last_valid": "last_valid", "zero": "zero", "remove": "remove"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
