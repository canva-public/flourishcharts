...
set_calculator_details <- function(
  ...
  if (!is.null(design_border_type)) {
    if (!design_border_type %in% list_design_border_type) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"border-bottom": "border-bottom", "border": "border"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && design_border_type %in% names(named_list)
        ) {
  ...
  if (!is.null(design_align_horizontal)) {
    if (!design_align_horizontal %in% list_design_align_horizontal) {
      stop(
        "`design_align_horizontal` must be one of: c('start', 'center', 'end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            design_align_horizontal %in% names(named_list)
        ) {
  ...
  if (!is.null(design_align_vertical)) {
    if (!design_align_vertical %in% list_design_align_vertical) {
      stop(
        "`design_align_vertical` must be one of: c('start', 'center', 'flex-end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"start": "start", "center": "center", "flex-end": "flex-end"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && design_align_vertical %in% names(named_list)
        ) {
  ...
  if (!is.null(design_border_style)) {
    if (!design_border_style %in% list_design_border_style) {
      stop(
        "`design_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && design_border_style %in% names(named_list)
        ) {
  ...
  if (length(result_variables) > 1) {
    new_list$x$state$result$variables <- paste(
      result_variables,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(result_font_weight)) {
    if (!result_font_weight %in% list_result_font_weight) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && result_font_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(result_font_style)) {
    if (!result_font_style %in% list_result_font_style) {
      ...
      if (
        length(jsonlite::fromJSON('{"normal": "normal", "italic": "italic"}')) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && result_font_style %in% names(named_list)
        ) {
  ...
  if (!is.null(result_border_type)) {
    if (!result_border_type %in% list_result_border_type) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && result_border_type %in% names(named_list)
        ) {
  ...
  if (!is.null(result_border_style)) {
    if (!result_border_style %in% list_result_border_style) {
      stop(
        "`result_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && result_border_style %in% names(named_list)
        ) {
  ...
  if (!is.null(result_bg_type)) {
    if (!result_bg_type %in% list_result_bg_type) {
      ...
      if (
        length(jsonlite::fromJSON('{"color": "color", "image": "image"}')) > 1
      ) {
  ...
  if (!is.null(result_bg_image_size)) {
    if (!result_bg_image_size %in% list_result_bg_image_size) {
      stop(
        "`result_bg_image_size` must be one of: c('auto', 'cover', 'contain')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && result_bg_image_size %in% names(named_list)
        ) {
  ...
  if (!is.null(design_question_font_size)) {
    if (!design_question_font_size %in% list_design_question_font_size) {
      stop(
        "`design_question_font_size` must be one of: c('1.4', '1.6', '2', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            design_question_font_size %in% names(named_list)
        ) {
  ...
  if (!is.null(design_question_font_weight)) {
    if (!design_question_font_weight %in% list_design_question_font_weight) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            design_question_font_weight %in% names(named_list)
        ) {
          if (is.logical(design_question_font_weight)) {
            design_question_font_weight <- as.character(
              design_question_font_weight
            )
          }
          named_list_value <- unname(named_list[design_question_font_weight])[[
            1
          ]]
  ...
  if (!is.null(design_question_font_style)) {
    if (!design_question_font_style %in% list_design_question_font_style) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            design_question_font_style %in% names(named_list)
        ) {
          if (is.logical(design_question_font_style)) {
            design_question_font_style <- as.character(
              design_question_font_style
            )
          }
          named_list_value <- unname(named_list[design_question_font_style])[[
            1
          ]]
  ...
  if (!is.null(design_context_font_size)) {
    if (!design_context_font_size %in% list_design_context_font_size) {
      stop(
        "`design_context_font_size` must be one of: c('1.4', '1.6', '2', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            design_context_font_size %in% names(named_list)
        ) {
  ...
  if (!is.null(design_context_font_weight)) {
    if (!design_context_font_weight %in% list_design_context_font_weight) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            design_context_font_weight %in% names(named_list)
        ) {
          if (is.logical(design_context_font_weight)) {
            design_context_font_weight <- as.character(
              design_context_font_weight
            )
          }
          named_list_value <- unname(named_list[design_context_font_weight])[[
            1
          ]]
  ...
  if (!is.null(design_context_font_style)) {
    if (!design_context_font_style %in% list_design_context_font_style) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            design_context_font_style %in% names(named_list)
        ) {
  ...
  if (!is.null(input_border_style)) {
    if (!input_border_style %in% list_input_border_style) {
      stop(
        "`input_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && input_border_style %in% names(named_list)
        ) {
  ...
  if (!is.null(button_font_size)) {
    if (!button_font_size %in% list_button_font_size) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"1": "1", "1.2": "1.2", "1.6": "1.6", "custom": "custom"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(button_border_style)) {
    if (!button_border_style %in% list_button_border_style) {
      stop(
        "`button_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && button_border_style %in% names(named_list)
        ) {
  ...
  if (!is.null(button_justify_content)) {
    if (!button_justify_content %in% list_button_justify_content) {
      stop(
        "`button_justify_content` must be one of: c('flex-start', 'center', 'flex-end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            button_justify_content %in% names(named_list)
        ) {
  ...
  if (!is.null(dropdown_font_size)) {
    if (!dropdown_font_size %in% list_dropdown_font_size) {
      stop(
        "`dropdown_font_size` must be one of: c('1', '1.2', '1.6', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && dropdown_font_size %in% names(named_list)
        ) {
  ...
  if (!is.null(dropdown_border_style)) {
    if (!dropdown_border_style %in% list_dropdown_border_style) {
      stop(
        "`dropdown_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && dropdown_border_style %in% names(named_list)
        ) {
  ...
  if (!is.null(dropdown_font_weight)) {
    if (!dropdown_font_weight %in% list_dropdown_font_weight) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && dropdown_font_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(dropdown_font_style)) {
    if (!dropdown_font_style %in% list_dropdown_font_style) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && dropdown_font_style %in% names(named_list)
        ) {
  ...
  if (!is.null(date_format)) {
    if (!date_format %in% list_date_format) {
      stop(
        "`date_format` must be one of: c('y-m-d', 'd/m/_y', 'd/m/y', 'j/n/_y', 'j/n/y', 'd-m-_y', 'd-m-y', 'j-n-_y', 'j-n-y', 'd.m._y', 'd.m.y', 'j.n._y', 'j.n.y', 'm/d/_y', 'm/d/y', 'n/j/_y', 'n/j/y', 'm-d-_y', 'm-d-y', 'n-j-_y', 'n-j-y', 'm j, _y', 'f j, _y')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"y-m-d": "Y-m-d", "d/m/_y": "d/m/Y", "d/m/y": "d/m/y", "j/n/_y": "j/n/Y", "j/n/y": "j/n/y", "d-m-_y": "d-m-Y", "d-m-y": "d-m-y", "j-n-_y": "j-n-Y", "j-n-y": "j-n-y", "d.m._y": "d.m.Y", "d.m.y": "d.m.y", "j.n._y": "j.n.Y", "j.n.y": "j.n.y", "m/d/_y": "m/d/Y", "m/d/y": "m/d/y", "n/j/_y": "n/j/Y", "n/j/y": "n/j/y", "m-d-_y": "m-d-Y", "m-d-y": "m-d-y", "n-j-_y": "n-j-Y", "n-j-y": "n-j-y", "m j, _y": "M j, Y", "f j, _y": "F j, Y"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(date_border_style)) {
    if (!date_border_style %in% list_date_border_style) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && date_border_style %in% names(named_list)
        ) {
  ...
  if (!is.null(date_calendar_position_vertical)) {
    if (
      !date_calendar_position_vertical %in% list_date_calendar_position_vertical
    ) {
      stop(
        "`date_calendar_position_vertical` must be one of: c('auto', 'above', 'below')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "above": "above", "below": "below"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            date_calendar_position_vertical %in% names(named_list)
        ) {
          if (is.logical(date_calendar_position_vertical)) {
            date_calendar_position_vertical <- as.character(
              date_calendar_position_vertical
            )
          }
          named_list_value <- unname(named_list[
            date_calendar_position_vertical
  ...
  if (!is.null(date_calendar_position_horizontal)) {
    if (
      !date_calendar_position_horizontal %in%
        list_date_calendar_position_horizontal
    ) {
      stop(
        "`date_calendar_position_horizontal` must be one of: c('left', 'center', 'right')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            date_calendar_position_horizontal %in% names(named_list)
        ) {
          if (is.logical(date_calendar_position_horizontal)) {
            date_calendar_position_horizontal <- as.character(
              date_calendar_position_horizontal
            )
          }
          named_list_value <- unname(named_list[
            date_calendar_position_horizontal
  ...
  if (!is.null(rating_icon_type)) {
    if (!rating_icon_type %in% list_rating_icon_type) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"star": "star", "circle": "circle", "check": "check"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(rating_label_position)) {
    if (!rating_label_position %in% list_rating_label_position) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && rating_label_position %in% names(named_list)
        ) {
  ...
  list_chart_slider_filter_controls_handle_shape <- c(
    "rectangle",
    "circle",
    NULL
  )
  if (!is.null(chart_slider_filter_controls_handle_shape)) {
    if (
      !chart_slider_filter_controls_handle_shape %in%
        list_chart_slider_filter_controls_handle_shape
    ) {
      stop(
        "`chart_slider_filter_controls_handle_shape` must be one of: c('rectangle', 'circle')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_slider_filter_controls_handle_shape %in% names(named_list)
        ) {
          if (is.logical(chart_slider_filter_controls_handle_shape)) {
            chart_slider_filter_controls_handle_shape <- as.character(
              chart_slider_filter_controls_handle_shape
            )
          }
          named_list_value <- unname(named_list[
            chart_slider_filter_controls_handle_shape
  ...
  if (length(submit_comment_text) > 1) {
    new_list$x$state$submit$comment$text <- paste(
      submit_comment_text,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(submit_bg_image_size)) {
    if (!submit_bg_image_size %in% list_submit_bg_image_size) {
      stop(
        "`submit_bg_image_size` must be one of: c('auto', 'cover', 'contain')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && submit_bg_image_size %in% names(named_list)
        ) {
  ...
  if (!is.null(submit_comment_font_size)) {
    if (!submit_comment_font_size %in% list_submit_comment_font_size) {
      stop(
        "`submit_comment_font_size` must be one of: c('1.4', '1.6', '2', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            submit_comment_font_size %in% names(named_list)
        ) {
  ...
  if (!is.null(submit_comment_font_weight)) {
    if (!submit_comment_font_weight %in% list_submit_comment_font_weight) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            submit_comment_font_weight %in% names(named_list)
        ) {
          if (is.logical(submit_comment_font_weight)) {
            submit_comment_font_weight <- as.character(
              submit_comment_font_weight
            )
          }
          named_list_value <- unname(named_list[submit_comment_font_weight])[[
            1
          ]]
  ...
  if (!is.null(submit_comment_font_style)) {
    if (!submit_comment_font_style %in% list_submit_comment_font_style) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            submit_comment_font_style %in% names(named_list)
        ) {
  ...
  if (!is.null(submit_flex_direction)) {
    if (!submit_flex_direction %in% list_submit_flex_direction) {
      stop(
        "`submit_flex_direction` must be one of: c('column', 'column-reverse')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && submit_flex_direction %in% names(named_list)
        ) {
  ...
  if (!is.null(submit_button_font_size)) {
    if (!submit_button_font_size %in% list_submit_button_font_size) {
      stop(
        "`submit_button_font_size` must be one of: c('1.4', '1.6', '2', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            submit_button_font_size %in% names(named_list)
        ) {
  ...
  if (!is.null(submit_button_font_weight)) {
    if (!submit_button_font_weight %in% list_submit_button_font_weight) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            submit_button_font_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(submit_button_font_style)) {
    if (!submit_button_font_style %in% list_submit_button_font_style) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            submit_button_font_style %in% names(named_list)
        ) {
  ...
  if (!is.null(submit_button_border_style)) {
    if (!submit_button_border_style %in% list_submit_button_border_style) {
      stop(
        "`submit_button_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            submit_button_border_style %in% names(named_list)
        ) {
          if (is.logical(submit_button_border_style)) {
            submit_button_border_style <- as.character(
              submit_button_border_style
            )
          }
          named_list_value <- unname(named_list[submit_button_border_style])[[
            1
          ]]
  ...
  list_design_controls_position <- c(
    "top_left",
    "top_centre",
    "top_right",
    "bottom_left",
  ...
  if (!is.null(design_controls_position)) {
    if (!design_controls_position %in% list_design_controls_position) {
      stop(
        "`design_controls_position` must be one of: c('top_left', 'top_centre', 'top_right', 'bottom_left', 'bottom_centre', 'bottom_right')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"top_left": "top_left", "top_centre": "top_centre", "top_right": "top_right", "bottom_left": "bottom_left", "bottom_centre": "bottom_centre", "bottom_right": "bottom_right"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            design_controls_position %in% names(named_list)
        ) {
  ...
  if (!is.null(design_controls_button_font_weight)) {
    if (
      !design_controls_button_font_weight %in%
        list_design_controls_button_font_weight
    ) {
      stop(
        "`design_controls_button_font_weight` must be one of: c('normal', 'bold')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"normal": "normal", "bold": "bold"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            design_controls_button_font_weight %in% names(named_list)
        ) {
          if (is.logical(design_controls_button_font_weight)) {
            design_controls_button_font_weight <- as.character(
              design_controls_button_font_weight
            )
          }
          named_list_value <- unname(named_list[
            design_controls_button_font_weight
  ...
  if (!is.null(design_controls_button_font_style)) {
    if (
      !design_controls_button_font_style %in%
        list_design_controls_button_font_style
    ) {
      stop(
        "`design_controls_button_font_style` must be one of: c('normal', 'italic')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"normal": "normal", "italic": "italic"}')) >
        ...
        if (
          length(named_list) > 1 &&
            design_controls_button_font_style %in% names(named_list)
        ) {
          if (is.logical(design_controls_button_font_style)) {
            design_controls_button_font_style <- as.character(
  ...
  list_design_controls_button_border_style <- c(
    "solid",
    "dashed",
    "dotted",
    NULL
  ...
  if (!is.null(design_controls_button_border_style)) {
    if (
      !design_controls_button_border_style %in%
        list_design_controls_button_border_style
    ) {
      stop(
        "`design_controls_button_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            design_controls_button_border_style %in% names(named_list)
        ) {
          if (is.logical(design_controls_button_border_style)) {
            design_controls_button_border_style <- as.character(
              design_controls_button_border_style
            )
          }
          named_list_value <- unname(named_list[
            design_controls_button_border_style
  ...
  if (!is.null(design_progress_position)) {
    if (!design_progress_position %in% list_design_progress_position) {
      ...
      if (
        length(jsonlite::fromJSON('{"top": "top", "bottom": "bottom"}')) > 1
      ) {
        ...
        if (
          length(named_list) > 1 &&
            design_progress_position %in% names(named_list)
        ) {
