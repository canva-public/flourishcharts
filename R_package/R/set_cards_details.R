...
set_cards_details <- function(
  ...
  if (!is.null(mode)) {
    if (!mode %in% list_mode) {
      ...
      if (
        length(jsonlite::fromJSON('{"grid": "grid", "carousel": "carousel"}')) >
          1
      ) {
  ...
  if (!is.null(autoplay_pause_when)) {
    if (!autoplay_pause_when %in% list_autoplay_pause_when) {
      stop(
        "`autoplay_pause_when` must be one of: c('never', 'hover', 'popup', 'hover_popup')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"never": "never", "hover": "hover", "popup": "popup", "hover_popup": "hover_popup"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && autoplay_pause_when %in% names(named_list)
        ) {
  ...
  if (!is.null(autoplay_btn_visible)) {
    if (!autoplay_btn_visible %in% list_autoplay_btn_visible) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && autoplay_btn_visible %in% names(named_list)
        ) {
  ...
  if (!is.null(autoplay_btn_position)) {
    if (!autoplay_btn_position %in% list_autoplay_btn_position) {
      stop(
        "`autoplay_btn_position` must be one of: c('top_left', 'top_right', 'bottom_left', 'bottom_right')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && autoplay_btn_position %in% names(named_list)
        ) {
  ...
  if (!is.null(card_layout)) {
    if (!card_layout %in% list_card_layout) {
      stop(
        "`card_layout` must be one of: c('portrait', 'landscape', 'absolute')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"portrait": "portrait", "landscape": "landscape", "absolute": "absolute"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(card_order)) {
    if (!card_order %in% list_card_order) {
      stop(
        "`card_order` must be one of: c('stack-default', 'stack-2', 'stack-3', 'stack-4')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
  ...
  if (length(template_simple_custom) > 1) {
    new_list$x$state$template_simple_custom <- paste(
      template_simple_custom,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(content_vertical_align)) {
    if (!content_vertical_align %in% list_content_vertical_align) {
      stop(
        "`content_vertical_align` must be one of: c('center', 'flex-start', 'flex-end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            content_vertical_align %in% names(named_list)
        ) {
  ...
  if (!is.null(text_column_names)) {
    if (!text_column_names %in% list_text_column_names) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && text_column_names %in% names(named_list)
        ) {
  ...
  if (!is.null(text_column_separator)) {
    if (!text_column_separator %in% list_text_column_separator) {
      stop(
        "`text_column_separator` must be one of: c(': ', ' - ', '<br>', 'other')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && text_column_separator %in% names(named_list)
        ) {
  ...
  if (!is.null(text_column_weight)) {
    if (!text_column_weight %in% list_text_column_weight) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && text_column_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(image_sizing)) {
    if (!image_sizing %in% list_image_sizing) {
      ...
      if (
        length(jsonlite::fromJSON('{"cover": "cover", "contain": "contain"}')) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(image_blend_mode)) {
    if (!image_blend_mode %in% list_image_blend_mode) {
      stop(
        "`image_blend_mode` must be one of: c('normal', 'lighten', 'darken', 'overlay', 'screen', 'multiply')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"normal": "normal", "lighten": "lighten", "darken": "darken", "overlay": "overlay", "screen": "screen", "multiply": "multiply"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(card_background_mode)) {
    if (!card_background_mode %in% list_card_background_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"transparent": "transparent", "fixed": "fixed"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && card_background_mode %in% names(named_list)
        ) {
  ...
  if (!is.null(card_background_mode_category)) {
    if (
      !card_background_mode_category %in% list_card_background_mode_category
    ) {
      stop(
        "`card_background_mode_category` must be one of: c('data', 'transparent', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"data": "data", "transparent": "transparent", "fixed": "fixed"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            card_background_mode_category %in% names(named_list)
        ) {
          if (is.logical(card_background_mode_category)) {
            card_background_mode_category <- as.character(
  ...
  if (!is.null(image_background_mode)) {
    if (!image_background_mode %in% list_image_background_mode) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && image_background_mode %in% names(named_list)
        ) {
  ...
  if (!is.null(image_background_mode_category)) {
    if (
      !image_background_mode_category %in% list_image_background_mode_category
    ) {
      stop(
        "`image_background_mode_category` must be one of: c('data', 'transparent', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            image_background_mode_category %in% names(named_list)
        ) {
          if (is.logical(image_background_mode_category)) {
            image_background_mode_category <- as.character(
              image_background_mode_category
            )
          }
          named_list_value <- unname(named_list[
            image_background_mode_category
  ...
  if (length(chart_popup_popup_custom_header) > 1) {
    new_list$x$state$popups$popup_custom_header <- paste(
  ...
  if (length(chart_popup_popup_custom_main) > 1) {
    new_list$x$state$popups$popup_custom_main <- paste(
  ...
  if (length(chart_popup_popup_custom_accessible) > 1) {
    new_list$x$state$popups$popup_custom_accessible <- paste(
  ...
  if (length(chart_popup_panel_side_default_content) > 1) {
    new_list$x$state$popups$panel_side_default_content <- paste(
  ...
  if (length(chart_popup_panel_custom_header) > 1) {
    new_list$x$state$popups$panel_custom_header <- paste(
  ...
  if (length(chart_popup_panel_custom_main) > 1) {
    new_list$x$state$popups$panel_custom_main <- paste(
  ...
  if (!is.null(audio_click)) {
    if (!audio_click %in% list_audio_click) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"replay": "replay", "stop": "stop", "pause": "pause"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
