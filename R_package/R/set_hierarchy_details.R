...
set_hierarchy_details <- function(
    ...
    if (!sort_by %in% list_sort_by) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"data": "data", "value": "value", "name": "name"}'
        )) >
          1
      ) {
  ...
  if (!is.null(treemap_type)) {
    if (!treemap_type %in% list_treemap_type) {
      stop(
        "`treemap_type` must be one of: c('treemap_binary', 'treemap_resquarify', 'treemap_slice', 'treemap_dice', 'treemap_slice_dice')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"treemap_binary": "treemapBinary", "treemap_resquarify": "treemapResquarify", "treemap_slice": "treemapSlice", "treemap_dice": "treemapDice", "treemap_slice_dice": "treemapSliceDice"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(sunburst_labelling)) {
    if (!sunburst_labelling %in% list_sunburst_labelling) {
      stop(
        "`sunburst_labelling` must be one of: c('auto', 'radial', 'circular')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "radial": "radial", "circular": "circular"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && sunburst_labelling %in% names(named_list)
        ) {
  ...
  if (!is.null(label_case)) {
    if (!label_case %in% list_label_case) {
      stop(
        "`label_case` must be one of: c('all_upper_case', 'all_lower_case', 'top_upper_case', 'bottom_upper_case')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"all_upper_case": "allUpperCase", "all_lower_case": "allLowerCase", "top_upper_case": "topUpperCase", "bottom_upper_case": "bottomUpperCase"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(label_weight)) {
    if (!label_weight %in% list_label_weight) {
      stop(
        "`label_weight` must be one of: c('all_normal', 'all_bold', 'top_bold', 'bottom_bold')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"all_normal": "allNormal", "all_bold": "allBold", "top_bold": "topBold", "bottom_bold": "bottomBold"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(bar_axis_labels_above)) {
    if (!bar_axis_labels_above %in% list_bar_axis_labels_above) {
      ...
      if (length(jsonlite::fromJSON('{"false": false, "true": true}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && bar_axis_labels_above %in% names(named_list)
        ) {
  ...
  if (!is.null(show_value_labels)) {
    if (!show_value_labels %in% list_show_value_labels) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && show_value_labels %in% names(named_list)
        ) {
  ...
  if (!is.null(chart_popup_mode)) {
    if (!chart_popup_mode %in% list_chart_popup_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"none": "none", "popup": "popup", "both": "both"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(popup_active_levels)) {
    if (!popup_active_levels %in% list_popup_active_levels) {
      stop(
        "`popup_active_levels` must be one of: c('all_levels', 'top_level', 'below_top_level', 'above_bottom_level', 'bottom_level')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"all_levels": "all_levels", "top_level": "top_level", "below_top_level": "below_top_level", "above_bottom_level": "above_bottom_level", "bottom_level": "bottom_level"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && popup_active_levels %in% names(named_list)
        ) {
  ...
  if (!is.null(filter_control_visibility)) {
    if (!filter_control_visibility %in% list_filter_control_visibility) {
      stop(
        "`filter_control_visibility` must be one of: c('always', 'editor', 'never')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            filter_control_visibility %in% names(named_list)
        ) {
  ...
  if (!is.null(size_by_control_visibility)) {
    if (!size_by_control_visibility %in% list_size_by_control_visibility) {
      stop(
        "`size_by_control_visibility` must be one of: c('always', 'editor', 'never')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            size_by_control_visibility %in% names(named_list)
        ) {
          if (is.logical(size_by_control_visibility)) {
            size_by_control_visibility <- as.character(
              size_by_control_visibility
            )
          }
          named_list_value <- unname(named_list[size_by_control_visibility])[[
            1
          ]]
  ...
  list_chart_size_filter_controls_control_type <- c(
    "dropdown",
    "buttons",
    "slider",
    NULL
  ...
  if (!is.null(chart_size_filter_controls_control_type)) {
    if (
      !chart_size_filter_controls_control_type %in%
        list_chart_size_filter_controls_control_type
    ) {
      stop(
        "`chart_size_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_size_filter_controls_control_type %in% names(named_list)
        ) {
          if (is.logical(chart_size_filter_controls_control_type)) {
            chart_size_filter_controls_control_type <- as.character(
              chart_size_filter_controls_control_type
            )
          }
          named_list_value <- unname(named_list[
            chart_size_filter_controls_control_type
  ...
  if (!is.null(chart_size_filter_controls_button_group)) {
    if (
      !chart_size_filter_controls_button_group %in%
        list_chart_size_filter_controls_button_group
    ) {
      stop(
        "`chart_size_filter_controls_button_group` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_size_filter_controls_button_group %in% names(named_list)
        ) {
          if (is.logical(chart_size_filter_controls_button_group)) {
            chart_size_filter_controls_button_group <- as.character(
  ...
  list_chart_size_filter_controls_button_group_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_size_filter_controls_button_group_width_mode)) {
    if (
      !chart_size_filter_controls_button_group_width_mode %in%
        list_chart_size_filter_controls_button_group_width_mode
    ) {
      stop(
        "`chart_size_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_size_filter_controls_button_group_width_mode)) {
            chart_size_filter_controls_button_group_width_mode <- as.character(
              chart_size_filter_controls_button_group_width_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_size_filter_controls_button_group_width_mode
  ...
  list_chart_size_filter_controls_dropdown_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_size_filter_controls_dropdown_width_mode)) {
    if (
      !chart_size_filter_controls_dropdown_width_mode %in%
        list_chart_size_filter_controls_dropdown_width_mode
    ) {
      stop(
        "`chart_size_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_size_filter_controls_dropdown_width_mode)) {
            chart_size_filter_controls_dropdown_width_mode <- as.character(
  ...
  if (!is.null(chart_size_filter_controls_sort)) {
    if (
      !chart_size_filter_controls_sort %in% list_chart_size_filter_controls_sort
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_size_filter_controls_sort %in% names(named_list)
        ) {
          if (is.logical(chart_size_filter_controls_sort)) {
            chart_size_filter_controls_sort <- as.character(
              chart_size_filter_controls_sort
            )
          }
          named_list_value <- unname(named_list[
            chart_size_filter_controls_sort
  ...
  if (!is.null(ascend_button_visibility)) {
    if (!ascend_button_visibility %in% list_ascend_button_visibility) {
      stop(
        "`ascend_button_visibility` must be one of: c('always', 'editor', 'never')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            ascend_button_visibility %in% names(named_list)
        ) {
  ...
  list_size_by_number_formatter_negative_sign <- c(
    "-$nk",
    "$-nk",
    "($nk)",
    "$(n)k",
  ...
  if (!is.null(size_by_number_formatter_negative_sign)) {
    if (
      !size_by_number_formatter_negative_sign %in%
        list_size_by_number_formatter_negative_sign
    ) {
      stop(
        "`size_by_number_formatter_negative_sign` must be one of: c('-$nk', '$-nk', '($nk)', '$(n)k', 'none')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            size_by_number_formatter_negative_sign %in% names(named_list)
        ) {
          if (is.logical(size_by_number_formatter_negative_sign)) {
            size_by_number_formatter_negative_sign <- as.character(
              size_by_number_formatter_negative_sign
            )
          }
          named_list_value <- unname(named_list[
            size_by_number_formatter_negative_sign
  ...
  list_size_by_number_formatter_transform <- c(
    "multiply",
    "divide",
    "exponentiate",
    NULL
  ...
  if (!is.null(size_by_number_formatter_transform)) {
    if (
      !size_by_number_formatter_transform %in%
        list_size_by_number_formatter_transform
    ) {
      stop(
        "`size_by_number_formatter_transform` must be one of: c('multiply', 'divide', 'exponentiate')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            size_by_number_formatter_transform %in% names(named_list)
        ) {
          if (is.logical(size_by_number_formatter_transform)) {
            size_by_number_formatter_transform <- as.character(
              size_by_number_formatter_transform
            )
          }
          named_list_value <- unname(named_list[
            size_by_number_formatter_transform
  ...
  list_filter_number_formatter_negative_sign <- c(
    "-$nk",
    "$-nk",
    "($nk)",
    "$(n)k",
  ...
  if (!is.null(filter_number_formatter_negative_sign)) {
    if (
      !filter_number_formatter_negative_sign %in%
        list_filter_number_formatter_negative_sign
    ) {
      stop(
        "`filter_number_formatter_negative_sign` must be one of: c('-$nk', '$-nk', '($nk)', '$(n)k', 'none')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            filter_number_formatter_negative_sign %in% names(named_list)
        ) {
          if (is.logical(filter_number_formatter_negative_sign)) {
            filter_number_formatter_negative_sign <- as.character(
              filter_number_formatter_negative_sign
            )
          }
          named_list_value <- unname(named_list[
            filter_number_formatter_negative_sign
  ...
  list_filter_number_formatter_transform <- c(
    "multiply",
    "divide",
    "exponentiate",
    NULL
  ...
  if (!is.null(filter_number_formatter_transform)) {
    if (
      !filter_number_formatter_transform %in%
        list_filter_number_formatter_transform
    ) {
      stop(
        "`filter_number_formatter_transform` must be one of: c('multiply', 'divide', 'exponentiate')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            filter_number_formatter_transform %in% names(named_list)
        ) {
          if (is.logical(filter_number_formatter_transform)) {
            filter_number_formatter_transform <- as.character(
