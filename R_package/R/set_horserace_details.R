...
set_horserace_details <- function(
  ...
  if (!is.null(value_type)) {
    if (!value_type %in% list_value_type) {
      ...
      if (
        length(jsonlite::fromJSON('{"ranks": "ranks", "scores": "scores"}')) > 1
      ) {
        named_list <- jsonlite::fromJSON(
          '{"ranks": "ranks", "scores": "scores"}'
        )
  ...
  if (!is.null(higher_scores_win)) {
    if (!higher_scores_win %in% list_higher_scores_win) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && higher_scores_win %in% names(named_list)
        ) {
    ...
    if (!ties_mode %in% list_ties_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"competition": "competition", "dense": "dense"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(height_mode)) {
    if (!height_mode %in% list_height_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "fixed": "fixed", "flexible": "flexible"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(color_mode)) {
    if (!color_mode %in% list_color_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"category": "category", "line": "line", "single": "single"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(curve)) {
    if (!curve %in% list_curve) {
      stop(
        "`curve` must be one of: c('curve_linear', 'curve_monotone_x', 'curve_natural', 'curve_step', 'curve_step_after', 'curve_step_before')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"curve_linear": "curveLinear", "curve_monotone_x": "curveMonotoneX", "curve_natural": "curveNatural", "curve_step": "curveStep", "curve_step_after": "curveStepAfter", "curve_step_before": "curveStepBefore"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(end_circle_stroke_bg)) {
    if (!end_circle_stroke_bg %in% list_end_circle_stroke_bg) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && end_circle_stroke_bg %in% names(named_list)
        ) {
  ...
  if (!is.null(show_labels)) {
    if (!show_labels %in% list_show_labels) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"always": "always", "hover": "hover", "never": "never"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(rank_outside_picture)) {
    if (!rank_outside_picture %in% list_rank_outside_picture) {
      ...
      if (length(jsonlite::fromJSON('{"false": false, "true": true}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && rank_outside_picture %in% names(named_list)
        ) {
  ...
  if (!is.null(caption_text_weight)) {
    if (!caption_text_weight %in% list_caption_text_weight) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && caption_text_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(caption_text_align_h)) {
    if (!caption_text_align_h %in% list_caption_text_align_h) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && caption_text_align_h %in% names(named_list)
        ) {
  ...
  if (!is.null(caption_text_align_v)) {
    if (!caption_text_align_v %in% list_caption_text_align_v) {
      stop(
        "`caption_text_align_v` must be one of: c('flex-start', 'center', 'flex-end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && caption_text_align_v %in% names(named_list)
        ) {
