...
set_line_bar_pie_details <- function(
    ...
    if (!stack_sort %in% list_stack_sort) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"data": "data", "ascending": "ascending", "descending": "descending"}'
        )) >
          1
      ) {
  ...
  if (!is.null(facet_layout)) {
    if (!facet_layout %in% list_facet_layout) {
      ...
      if (
        length(jsonlite::fromJSON('{"single": "single", "facets": "facets"}')) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
          '{"single": "single", "facets": "facets"}'
        )
        # Get the names of the list
        names_list <- names(named_list)
        # Convert names to boolean values only if they are "true" or "false"
  ...
  if (!is.null(height_mode)) {
    if (!height_mode %in% list_height_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "fill_space": "fill_space", "aspect": "aspect"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(sort_mode)) {
    if (!sort_mode %in% list_sort_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"data": "data", "value": "value", "label": "label"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(series_filter_mode)) {
    if (!series_filter_mode %in% list_series_filter_mode) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && series_filter_mode %in% names(named_list)
        ) {
  ...
  list_chart_series_filter_controls_control_type <- c(
    "dropdown",
    "buttons",
    "slider",
    NULL
  ...
  if (!is.null(chart_series_filter_controls_control_type)) {
    if (
      !chart_series_filter_controls_control_type %in%
        list_chart_series_filter_controls_control_type
    ) {
      stop(
        "`chart_series_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_series_filter_controls_control_type %in% names(named_list)
        ) {
          if (is.logical(chart_series_filter_controls_control_type)) {
            chart_series_filter_controls_control_type <- as.character(
  ...
  if (!is.null(chart_series_filter_controls_button_group)) {
    if (
      !chart_series_filter_controls_button_group %in%
        list_chart_series_filter_controls_button_group
    ) {
      stop(
        "`chart_series_filter_controls_button_group` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_series_filter_controls_button_group %in% names(named_list)
        ) {
          if (is.logical(chart_series_filter_controls_button_group)) {
            chart_series_filter_controls_button_group <- as.character(
  ...
  list_chart_series_filter_controls_button_group_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_series_filter_controls_button_group_width_mode)) {
    if (
      !chart_series_filter_controls_button_group_width_mode %in%
        list_chart_series_filter_controls_button_group_width_mode
    ) {
      stop(
        "`chart_series_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (
            is.logical(chart_series_filter_controls_button_group_width_mode)
          ) {
            chart_series_filter_controls_button_group_width_mode <- as.character(
  ...
  list_chart_series_filter_controls_dropdown_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_series_filter_controls_dropdown_width_mode)) {
    if (
      !chart_series_filter_controls_dropdown_width_mode %in%
        list_chart_series_filter_controls_dropdown_width_mode
    ) {
      stop(
        "`chart_series_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_series_filter_controls_dropdown_width_mode)) {
            chart_series_filter_controls_dropdown_width_mode <- as.character(
  ...
  if (!is.null(chart_series_filter_controls_sort)) {
    if (
      !chart_series_filter_controls_sort %in%
        list_chart_series_filter_controls_sort
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_series_filter_controls_sort %in% names(named_list)
        ) {
          if (is.logical(chart_series_filter_controls_sort)) {
            chart_series_filter_controls_sort <- as.character(
  ...
  list_chart_row_filter_controls_control_type <- c(
    "dropdown",
    "buttons",
    "slider",
    NULL
  ...
  if (!is.null(chart_row_filter_controls_control_type)) {
    if (
      !chart_row_filter_controls_control_type %in%
        list_chart_row_filter_controls_control_type
    ) {
      stop(
        "`chart_row_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_row_filter_controls_control_type %in% names(named_list)
        ) {
          if (is.logical(chart_row_filter_controls_control_type)) {
            chart_row_filter_controls_control_type <- as.character(
  ...
  if (!is.null(chart_row_filter_controls_button_group)) {
    if (
      !chart_row_filter_controls_button_group %in%
        list_chart_row_filter_controls_button_group
    ) {
      stop(
        "`chart_row_filter_controls_button_group` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_row_filter_controls_button_group %in% names(named_list)
        ) {
          if (is.logical(chart_row_filter_controls_button_group)) {
            chart_row_filter_controls_button_group <- as.character(
  ...
  list_chart_row_filter_controls_button_group_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_row_filter_controls_button_group_width_mode)) {
    if (
      !chart_row_filter_controls_button_group_width_mode %in%
        list_chart_row_filter_controls_button_group_width_mode
    ) {
      stop(
        "`chart_row_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_row_filter_controls_button_group_width_mode)) {
            chart_row_filter_controls_button_group_width_mode <- as.character(
  ...
  list_chart_row_filter_controls_dropdown_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_row_filter_controls_dropdown_width_mode)) {
    if (
      !chart_row_filter_controls_dropdown_width_mode %in%
        list_chart_row_filter_controls_dropdown_width_mode
    ) {
      stop(
        "`chart_row_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_row_filter_controls_dropdown_width_mode %in% names(named_list)
        ) {
          if (is.logical(chart_row_filter_controls_dropdown_width_mode)) {
            chart_row_filter_controls_dropdown_width_mode <- as.character(
  ...
  if (!is.null(chart_row_filter_controls_sort)) {
    if (
      !chart_row_filter_controls_sort %in% list_chart_row_filter_controls_sort
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_row_filter_controls_sort %in% names(named_list)
        ) {
          if (is.logical(chart_row_filter_controls_sort)) {
            chart_row_filter_controls_sort <- as.character(
  ...
  list_chart_log_control_y_filter_controls_control_type <- c(
    "dropdown",
    "buttons",
    "slider",
    NULL
  ...
  if (!is.null(chart_log_control_y_filter_controls_control_type)) {
    if (
      !chart_log_control_y_filter_controls_control_type %in%
        list_chart_log_control_y_filter_controls_control_type
    ) {
      stop(
        "`chart_log_control_y_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_log_control_y_filter_controls_control_type)) {
            chart_log_control_y_filter_controls_control_type <- as.character(
  ...
  if (!is.null(chart_log_control_y_filter_controls_button_group)) {
    if (
      !chart_log_control_y_filter_controls_button_group %in%
        list_chart_log_control_y_filter_controls_button_group
    ) {
      stop(
        "`chart_log_control_y_filter_controls_button_group` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          ...
          if (is.logical(chart_log_control_y_filter_controls_button_group)) {
            chart_log_control_y_filter_controls_button_group <- as.character(
  ...
  list_chart_log_control_y_filter_controls_button_group_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_log_control_y_filter_controls_button_group_width_mode)) {
    if (
      !chart_log_control_y_filter_controls_button_group_width_mode %in%
        list_chart_log_control_y_filter_controls_button_group_width_mode
    ) {
      stop(
        "`chart_log_control_y_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (
            ...
            chart_log_control_y_filter_controls_button_group_width_mode <- as.character(
              chart_log_control_y_filter_controls_button_group_width_mode
            )
          }
          named_list_value <- unname(named_list[
  ...
  list_chart_log_control_y_filter_controls_dropdown_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_log_control_y_filter_controls_dropdown_width_mode)) {
    if (
      !chart_log_control_y_filter_controls_dropdown_width_mode %in%
        list_chart_log_control_y_filter_controls_dropdown_width_mode
    ) {
      stop(
        "`chart_log_control_y_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (
            is.logical(chart_log_control_y_filter_controls_dropdown_width_mode)
          ) {
            chart_log_control_y_filter_controls_dropdown_width_mode <- as.character(
  ...
  if (!is.null(chart_log_control_y_filter_controls_sort)) {
    if (
      !chart_log_control_y_filter_controls_sort %in%
        list_chart_log_control_y_filter_controls_sort
    ) {
      stop(
        "`chart_log_control_y_filter_controls_sort` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_log_control_y_filter_controls_sort %in% names(named_list)
        ) {
          if (is.logical(chart_log_control_y_filter_controls_sort)) {
            chart_log_control_y_filter_controls_sort <- as.character(
  ...
  if (!is.null(controls_position)) {
    if (!controls_position %in% list_controls_position) {
      stop(
        "`controls_position` must be one of: c('log_series_row', 'series_log_row', 'log_row_series', 'series_row_log', 'row_log_series', 'row_series_log')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"log_series_row": "log_series_row", "series_log_row": "series_log_row", "log_row_series": "log_row_series", "series_row_log": "series_row_log", "row_log_series": "row_log_series", "row_series_log": "row_series_log"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && controls_position %in% names(named_list)
        ) {
  ...
  if (!is.null(color_mode)) {
    if (!color_mode %in% list_color_mode) {
      ...
      if (
        length(jsonlite::fromJSON('{"column": "column", "row": "row"}')) > 1
      ) {
  ...
  if (!is.null(line_curve)) {
    if (!line_curve %in% list_line_curve) {
      stop(
        "`line_curve` must be one of: c('curve_linear', 'curve_monotone_x', 'curve_natural', 'curve_step', 'curve_step_before', 'curve_step_after')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"curve_linear": "curveLinear", "curve_monotone_x": "curveMonotoneX", "curve_natural": "curveNatural", "curve_step": "curveStep", "curve_step_before": "curveStepBefore", "curve_step_after": "curveStepAfter"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (length(shade_between_lines_config) > 1) {
    new_list$x$state$shade_between_lines_config <- paste(
  ...
  if (!is.null(bar_labels_weight)) {
    if (!bar_labels_weight %in% list_bar_labels_weight) {
      ...
      if (length(jsonlite::fromJSON('{"600": "600", "400": "400"}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && bar_labels_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(chart_line_labels_overlap_mode)) {
    if (
      !chart_line_labels_overlap_mode %in% list_chart_line_labels_overlap_mode
    ) {
      stop(
        "`chart_line_labels_overlap_mode` must be one of: c('spread', 'hide', 'none')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_line_labels_overlap_mode %in% names(named_list)
        ) {
          if (is.logical(chart_line_labels_overlap_mode)) {
            chart_line_labels_overlap_mode <- as.character(
  ...
  if (length(chart_line_labels_show_only_labels) > 1) {
    new_list$x$state$line_labels$show_only_labels <- paste(
  ...
  if (!is.null(chart_line_labels_text_weight)) {
    if (
      !chart_line_labels_text_weight %in% list_chart_line_labels_text_weight
    ) {
      ...
      if (length(jsonlite::fromJSON('{"400": 400, "700": 700}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_line_labels_text_weight %in% names(named_list)
        ) {
          if (is.logical(chart_line_labels_text_weight)) {
            chart_line_labels_text_weight <- as.character(
  ...
  if (!is.null(chart_line_labels_lines)) {
    if (!chart_line_labels_lines %in% list_chart_line_labels_lines) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            chart_line_labels_lines %in% names(named_list)
        ) {
  ...
  if (!is.null(chart_line_labels_line_style)) {
    if (!chart_line_labels_line_style %in% list_chart_line_labels_line_style) {
      stop(
        "`chart_line_labels_line_style` must be one of: c('straight', 'step')"
      )
    } else {
      if (
        ...
        if (
          length(named_list) > 1 &&
            chart_line_labels_line_style %in% names(named_list)
        ) {
          if (is.logical(chart_line_labels_line_style)) {
            chart_line_labels_line_style <- as.character(
              chart_line_labels_line_style
            )
          }
          named_list_value <- unname(named_list[chart_line_labels_line_style])[[
            1
          ]]
  ...
  if (!is.null(labels_column_align)) {
    if (!labels_column_align %in% list_labels_column_align) {
      stop(
        "`labels_column_align` must be one of: c('bottom', 'middle', 'top', 'above')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"bottom": "bottom", "middle": "middle", "top": "top", "above": "above"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && labels_column_align %in% names(named_list)
        ) {
  ...
  if (!is.null(labels_bar_align)) {
    if (!labels_bar_align %in% list_labels_bar_align) {
      stop(
        "`labels_bar_align` must be one of: c('left', 'center', 'right', 'out')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"left": "left", "center": "center", "right": "right", "out": "out"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(labels_color_mode)) {
    if (!labels_color_mode %in% list_labels_color_mode) {
      stop(
        "`labels_color_mode` must be one of: c('auto', 'data', 'contrast', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "data": "data", "contrast": "contrast", "fixed": "fixed"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && labels_color_mode %in% names(named_list)
        ) {
  ...
  if (!is.null(labels_font_weight)) {
    if (!labels_font_weight %in% list_labels_font_weight) {
      ...
      if (length(jsonlite::fromJSON('{"600": "600", "400": "400"}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && labels_font_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(labels_font_size_mode)) {
    if (!labels_font_size_mode %in% list_labels_font_size_mode) {
      ...
      if (
        length(jsonlite::fromJSON('{"auto": "auto", "fixed": "fixed"}')) > 1
      ) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && labels_font_size_mode %in% names(named_list)
        ) {
  ...
  if (!is.null(labels_content)) {
    if (!labels_content %in% list_labels_content) {
      stop(
        "`labels_content` must be one of: c('auto', 'value', 'label', 'both')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "value": "value", "label": "label", "both": "both"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(stack_labels_weight)) {
    if (!stack_labels_weight %in% list_stack_labels_weight) {
      ...
      if (length(jsonlite::fromJSON('{"600": "600", "400": "400"}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && stack_labels_weight %in% names(named_list)
        ) {
  ...
  list_chart_x_axis_axis_position <- c(
    "bottom",
    "float-below",
    "float-above",
    "top",
  ...
  if (!is.null(chart_x_axis_axis_position)) {
    if (!chart_x_axis_axis_position %in% list_chart_x_axis_axis_position) {
      stop(
        "`chart_x_axis_axis_position` must be one of: c('bottom', 'float-below', 'float-above', 'top', 'off')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"bottom": "bottom", "float-below": "float-below", "float-above": "float-above", "top": "top", "off": "off"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(chart_secondary_y_axis_axis_visible)) {
    if (
      !chart_secondary_y_axis_axis_visible %in%
        list_chart_secondary_y_axis_axis_visible
    ) {
      stop(
        "`chart_secondary_y_axis_axis_visible` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_axis_visible %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_axis_visible)) {
            chart_secondary_y_axis_axis_visible <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_numeric_scale_type)) {
    if (
      !chart_secondary_y_axis_numeric_scale_type %in%
        list_chart_secondary_y_axis_numeric_scale_type
    ) {
      stop(
        "`chart_secondary_y_axis_numeric_scale_type` must be one of: c('linear', 'log')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"linear": "linear", "log": "log"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_numeric_scale_type %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_numeric_scale_type)) {
            chart_secondary_y_axis_numeric_scale_type <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_nice)) {
    if (!chart_secondary_y_axis_nice %in% list_chart_secondary_y_axis_nice) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_nice %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_nice)) {
            chart_secondary_y_axis_nice <- as.character(
              chart_secondary_y_axis_nice
            )
          }
          named_list_value <- unname(named_list[chart_secondary_y_axis_nice])[[
            1
          ]]
  ...
  if (!is.null(chart_secondary_y_axis_zero_axis)) {
    if (
      !chart_secondary_y_axis_zero_axis %in%
        list_chart_secondary_y_axis_zero_axis
    ) {
      stop(
        "`chart_secondary_y_axis_zero_axis` must be one of: c('auto', 'on', 'off')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_zero_axis %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_zero_axis)) {
            chart_secondary_y_axis_zero_axis <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_title_mode)) {
    if (
      !chart_secondary_y_axis_title_mode %in%
        list_chart_secondary_y_axis_title_mode
    ) {
      stop(
        "`chart_secondary_y_axis_title_mode` must be one of: c('auto', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"auto": "auto", "custom": "custom"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_title_mode %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_title_mode)) {
            chart_secondary_y_axis_title_mode <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_title_position)) {
    if (
      !chart_secondary_y_axis_title_position %in%
        list_chart_secondary_y_axis_title_position
    ) {
      stop(
        "`chart_secondary_y_axis_title_position` must be one of: c('side', 'end')"
      )
    } else {
      if (length(jsonlite::fromJSON('{"side": "side", "end": "end"}')) > 1) {
        named_list <- jsonlite::fromJSON('{"side": "side", "end": "end"}')
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_title_position %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_title_position)) {
            chart_secondary_y_axis_title_position <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_title_weight)) {
    if (
      !chart_secondary_y_axis_title_weight %in%
        list_chart_secondary_y_axis_title_weight
    ) {
      stop(
        "`chart_secondary_y_axis_title_weight` must be one of: c('bold', 'normal')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"bold": "bold", "normal": "normal"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_title_weight %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_title_weight)) {
            chart_secondary_y_axis_title_weight <- as.character(
  ...
  list_chart_secondary_y_axis_tick_label_position <- c(
    "default",
    "above",
    "below",
    NULL
  ...
  if (!is.null(chart_secondary_y_axis_tick_label_position)) {
    if (
      !chart_secondary_y_axis_tick_label_position %in%
        list_chart_secondary_y_axis_tick_label_position
    ) {
      stop(
        "`chart_secondary_y_axis_tick_label_position` must be one of: c('default', 'above', 'below')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_tick_label_position %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_tick_label_position)) {
            chart_secondary_y_axis_tick_label_position <- as.character(
  ...
  list_chart_secondary_y_axis_tick_label_angle <- c(
    "0",
    "30",
    "45",
    "60",
  ...
  if (!is.null(chart_secondary_y_axis_tick_label_angle)) {
    if (
      !chart_secondary_y_axis_tick_label_angle %in%
        list_chart_secondary_y_axis_tick_label_angle
    ) {
      stop(
        "`chart_secondary_y_axis_tick_label_angle` must be one of: c('0', '30', '45', '60', '90')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_tick_label_angle %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_tick_label_angle)) {
            chart_secondary_y_axis_tick_label_angle <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_tick_label_weight)) {
    if (
      !chart_secondary_y_axis_tick_label_weight %in%
        list_chart_secondary_y_axis_tick_label_weight
    ) {
      stop(
        "`chart_secondary_y_axis_tick_label_weight` must be one of: c('bold', 'normal')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"bold": "bold", "normal": "normal"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_tick_label_weight %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_tick_label_weight)) {
            chart_secondary_y_axis_tick_label_weight <- as.character(
  ...
  list_chart_secondary_y_axis_tick_label_space_mode <- c(
    "auto",
    "max",
    "fixed",
    NULL
  ...
  if (!is.null(chart_secondary_y_axis_tick_label_space_mode)) {
    if (
      !chart_secondary_y_axis_tick_label_space_mode %in%
        list_chart_secondary_y_axis_tick_label_space_mode
    ) {
      stop(
        "`chart_secondary_y_axis_tick_label_space_mode` must be one of: c('auto', 'max', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_tick_label_space_mode %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_tick_label_space_mode)) {
            chart_secondary_y_axis_tick_label_space_mode <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_tick_mode)) {
    if (
      !chart_secondary_y_axis_tick_mode %in%
        list_chart_secondary_y_axis_tick_mode
    ) {
      stop(
        "`chart_secondary_y_axis_tick_mode` must be one of: c('auto', 'number', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_tick_mode %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_tick_mode)) {
            chart_secondary_y_axis_tick_mode <- as.character(
  ...
  if (length(chart_secondary_y_axis_tick_custom) > 1) {
    new_list$x$state$y2$tick_custom <- paste(
  ...
  if (!is.null(chart_secondary_y_axis_tick_side)) {
    if (
      !chart_secondary_y_axis_tick_side %in%
        list_chart_secondary_y_axis_tick_side
    ) {
      ...
      if (length(jsonlite::fromJSON('{"out": "out", "in": "in"}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_tick_side %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_tick_side)) {
            chart_secondary_y_axis_tick_side <- as.character(
  ...
  if (!is.null(chart_secondary_y_axis_gridlines_visible)) {
    if (
      !chart_secondary_y_axis_gridlines_visible %in%
        list_chart_secondary_y_axis_gridlines_visible
    ) {
      stop(
        "`chart_secondary_y_axis_gridlines_visible` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_gridlines_visible %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_gridlines_visible)) {
            chart_secondary_y_axis_gridlines_visible <- as.character(
  ...
  list_chart_secondary_y_axis_gridline_style <- c(
    "solid",
    "dash",
    "dot",
    "dot_dash",
  ...
  if (!is.null(chart_secondary_y_axis_gridline_style)) {
    if (
      !chart_secondary_y_axis_gridline_style %in%
        list_chart_secondary_y_axis_gridline_style
    ) {
      stop(
        "`chart_secondary_y_axis_gridline_style` must be one of: c('solid', 'dash', 'dot', 'dot_dash')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_y_axis_gridline_style %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_y_axis_gridline_style)) {
            chart_secondary_y_axis_gridline_style <- as.character(
  ...
  list_number_format_labels_negative_sign <- c(
    "-$nk",
    "$-nk",
    "($nk)",
    "$(n)k",
  ...
  if (!is.null(number_format_labels_negative_sign)) {
    if (
      !number_format_labels_negative_sign %in%
        list_number_format_labels_negative_sign
    ) {
      stop(
        "`number_format_labels_negative_sign` must be one of: c('-$nk', '$-nk', '($nk)', '$(n)k', 'none')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            number_format_labels_negative_sign %in% names(named_list)
        ) {
          if (is.logical(number_format_labels_negative_sign)) {
            number_format_labels_negative_sign <- as.character(
  ...
  list_number_format_labels_transform <- c(
    "multiply",
    "divide",
    "exponentiate",
    NULL
  ...
  if (!is.null(number_format_labels_transform)) {
    if (
      !number_format_labels_transform %in% list_number_format_labels_transform
    ) {
      stop(
        "`number_format_labels_transform` must be one of: c('multiply', 'divide', 'exponentiate')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            number_format_labels_transform %in% names(named_list)
        ) {
          if (is.logical(number_format_labels_transform)) {
            number_format_labels_transform <- as.character(
  ...
  list_chart_secondary_number_date_format_negative_sign <- c(
    "-$nk",
    "$-nk",
    "($nk)",
    "$(n)k",
  ...
  if (!is.null(chart_secondary_number_date_format_negative_sign)) {
    if (
      !chart_secondary_number_date_format_negative_sign %in%
        list_chart_secondary_number_date_format_negative_sign
    ) {
      stop(
        "`chart_secondary_number_date_format_negative_sign` must be one of: c('-$nk', '$-nk', '($nk)', '$(n)k', 'none')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_secondary_number_date_format_negative_sign)) {
            chart_secondary_number_date_format_negative_sign <- as.character(
  ...
  list_chart_secondary_number_date_format_transform <- c(
    "multiply",
    "divide",
    "exponentiate",
    NULL
  ...
  if (!is.null(chart_secondary_number_date_format_transform)) {
    if (
      !chart_secondary_number_date_format_transform %in%
        list_chart_secondary_number_date_format_transform
    ) {
      stop(
        "`chart_secondary_number_date_format_transform` must be one of: c('multiply', 'divide', 'exponentiate')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_secondary_number_date_format_transform %in% names(named_list)
        ) {
          if (is.logical(chart_secondary_number_date_format_transform)) {
            chart_secondary_number_date_format_transform <- as.character(
  ...
  if (!is.null(legend_filter_mode)) {
    if (!legend_filter_mode %in% list_legend_filter_mode) {
      stop(
        "`legend_filter_mode` must be one of: c('none', 'filter-in', 'filter-out')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"none": "none", "filter-in": "filter-in", "filter-out": "filter-out"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && legend_filter_mode %in% names(named_list)
        ) {
  ...
  if (!is.null(legend_position)) {
    if (!legend_position %in% list_legend_position) {
      ...
      if (
        length(jsonlite::fromJSON('{"above": "above", "below": "below"}')) > 1
      ) {
  ...
  if (!is.null(text_legend)) {
    if (!text_legend %in% list_text_legend) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "custom": "custom", "off": "off"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (length(popup_series_text) > 1) {
    new_list$x$state$popup_series_text <- paste(
      popup_series_text,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(chart_axes_highlights_placement)) {
    if (
      !chart_axes_highlights_placement %in% list_chart_axes_highlights_placement
    ) {
      stop(
        "`chart_axes_highlights_placement` must be one of: c('above', 'below')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"above": "above", "below": "below"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_axes_highlights_placement %in% names(named_list)
        ) {
          if (is.logical(chart_axes_highlights_placement)) {
            chart_axes_highlights_placement <- as.character(
  ...
  if (length(chart_url_settings_whitelist) > 1) {
    new_list$x$state$url_state$whitelist <- paste(
