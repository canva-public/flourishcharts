...
set_pictogram_details <- function(
  ...
  if (!is.null(icon_style)) {
    if (!icon_style %in% list_icon_style) {
      ...
      if (
        length(jsonlite::fromJSON('{"solid": "solid", "outline": "outline"}')) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(filler_icons)) {
    if (!filler_icons %in% list_filler_icons) {
      stop(
        "`filler_icons` must be one of: c('auto', 'user', 'female', 'male', 'baby', 'child', 'wheelchair', 'angry', 'frown', 'meh', 'smile', 'smile-beam', 'thumbs-up', 'thumbs-down', 'hands-helping', 'hand-rock', 'hand-peace', 'dollar-sign', 'euro-sign', 'money-bill', 'money-bill-wave', 'pound-sign', 'coins', 'shopping-bag', 'shopping-cart', 'circle', 'square', 'star', 'heart', 'comment', 'cat', 'dog', 'dove', 'bus', 'car', 'biking', 'running', 'plane', 'suitcase', 'pizza-slice', 'ice-cream', 'coffee', 'wine-glass-alt', 'building', 'home', 'store', 'industry', 'database', 'laptop', 'microchip', 'phone', 'mobile-alt', 'tv', 'clock', 'atom', 'award', 'music', 'leaf', 'lightbulb', 'sun', 'wrench', 'airbnb', 'amazon', 'android', 'apple', 'bitcoin', 'facebook', 'google', 'linux', 'microsoft', 'twitter', 'windows', 'youtube')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "user": "user", "female": "female", "male": "male", "baby": "baby", "child": "child", "wheelchair": "wheelchair", "angry": "angry", "frown": "frown", "meh": "meh", "smile": "smile", "smile-beam": "smile-beam", "thumbs-up": "thumbs-up", "thumbs-down": "thumbs-down", "hands-helping": "hands-helping", "hand-rock": "hand-rock", "hand-peace": "hand-peace", "dollar-sign": "dollar-sign", "euro-sign": "euro-sign", "money-bill": "money-bill", "money-bill-wave": "money-bill-wave", "pound-sign": "pound-sign", "coins": "coins", "shopping-bag": "shopping-bag", "shopping-cart": "shopping-cart", "circle": "circle", "square": "square", "star": "star", "heart": "heart", "comment": "comment", "cat": "cat", "dog": "dog", "dove": "dove", "bus": "bus", "car": "car", "biking": "biking", "running": "running", "plane": "plane", "suitcase": "suitcase", "pizza-slice": "pizza-slice", "ice-cream": "ice-cream", "coffee": "coffee", "wine-glass-alt": "wine-glass-alt", "building": "building", "home": "home", "store": "store", "industry": "industry", "database": "database", "laptop": "laptop", "microchip": "microchip", "phone": "phone", "mobile-alt": "mobile-alt", "tv": "tv", "clock": "clock", "atom": "atom", "award": "award", "music": "music", "leaf": "leaf", "lightbulb": "lightbulb", "sun": "sun", "wrench": "wrench", "airbnb": "airbnb", "amazon": "amazon", "android": "android", "apple": "apple", "bitcoin": "bitcoin", "facebook": "facebook", "google": "google", "linux": "linux", "microsoft": "microsoft", "twitter": "twitter", "windows": "windows", "youtube": "youtube"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (length(chart_x_axis_tick_custom) > 1) {
    new_list$x$state$axis$tick_custom <- paste(
  ...
  if (!is.null(chart_value_legend_show_legend)) {
    if (
      !chart_value_legend_show_legend %in% list_chart_value_legend_show_legend
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_value_legend_show_legend %in% names(named_list)
        ) {
          if (is.logical(chart_value_legend_show_legend)) {
            chart_value_legend_show_legend <- as.character(
              chart_value_legend_show_legend
            )
          }
          named_list_value <- unname(named_list[
            chart_value_legend_show_legend
  ...
  if (!is.null(chart_value_legend_title_mode)) {
    if (
      !chart_value_legend_title_mode %in% list_chart_value_legend_title_mode
    ) {
      stop(
        "`chart_value_legend_title_mode` must be one of: c('auto', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"auto": "auto", "custom": "custom"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_value_legend_title_mode %in% names(named_list)
        ) {
          if (is.logical(chart_value_legend_title_mode)) {
            chart_value_legend_title_mode <- as.character(
              chart_value_legend_title_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_value_legend_title_mode
  ...
  if (length(chart_value_legend_order_override) > 1) {
    new_list$x$state$value_legend$order_override <- paste(
      chart_value_legend_order_override,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(chart_value_legend_orientation)) {
    if (
      !chart_value_legend_orientation %in% list_chart_value_legend_orientation
    ) {
      stop(
        "`chart_value_legend_orientation` must be one of: c('horizontal', 'vertical')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_value_legend_orientation %in% names(named_list)
        ) {
          if (is.logical(chart_value_legend_orientation)) {
            chart_value_legend_orientation <- as.character(
              chart_value_legend_orientation
            )
          }
          named_list_value <- unname(named_list[
            chart_value_legend_orientation
  ...
  if (!is.null(value_legend_icon)) {
    if (!value_legend_icon %in% list_value_legend_icon) {
      stop(
        "`value_legend_icon` must be one of: c('auto', 'user', 'female', 'male', 'baby', 'child', 'wheelchair', 'angry', 'frown', 'meh', 'smile', 'smile-beam', 'thumbs-up', 'thumbs-down', 'hands-helping', 'hand-rock', 'hand-peace', 'dollar-sign', 'euro-sign', 'money-bill', 'money-bill-wave', 'pound-sign', 'coins', 'shopping-bag', 'shopping-cart', 'circle', 'square', 'star', 'heart', 'comment', 'cat', 'dog', 'dove', 'bus', 'car', 'biking', 'running', 'plane', 'suitcase', 'pizza-slice', 'ice-cream', 'coffee', 'wine-glass-alt', 'building', 'home', 'store', 'industry', 'database', 'laptop', 'microchip', 'phone', 'mobile-alt', 'tv', 'clock', 'atom', 'award', 'music', 'leaf', 'lightbulb', 'sun', 'wrench', 'airbnb', 'amazon', 'android', 'apple', 'bitcoin', 'facebook', 'google', 'linux', 'microsoft', 'twitter', 'windows', 'youtube')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && value_legend_icon %in% names(named_list)
        ) {
  ...
  if (!is.null(chart_icon_legend_show_legend)) {
    if (
      !chart_icon_legend_show_legend %in% list_chart_icon_legend_show_legend
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_icon_legend_show_legend %in% names(named_list)
        ) {
          if (is.logical(chart_icon_legend_show_legend)) {
            chart_icon_legend_show_legend <- as.character(
              chart_icon_legend_show_legend
            )
          }
          named_list_value <- unname(named_list[
            chart_icon_legend_show_legend
  ...
  if (!is.null(chart_icon_legend_title_mode)) {
    if (!chart_icon_legend_title_mode %in% list_chart_icon_legend_title_mode) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            chart_icon_legend_title_mode %in% names(named_list)
        ) {
          if (is.logical(chart_icon_legend_title_mode)) {
            chart_icon_legend_title_mode <- as.character(
              chart_icon_legend_title_mode
            )
          }
          named_list_value <- unname(named_list[chart_icon_legend_title_mode])[[
            1
          ]]
  ...
  if (length(chart_icon_legend_order_override) > 1) {
    new_list$x$state$icon_legend$order_override <- paste(
      chart_icon_legend_order_override,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(chart_icon_legend_orientation)) {
    if (
      !chart_icon_legend_orientation %in% list_chart_icon_legend_orientation
    ) {
      stop(
        "`chart_icon_legend_orientation` must be one of: c('horizontal', 'vertical')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_icon_legend_orientation %in% names(named_list)
        ) {
          if (is.logical(chart_icon_legend_orientation)) {
            chart_icon_legend_orientation <- as.character(
              chart_icon_legend_orientation
            )
          }
          named_list_value <- unname(named_list[
            chart_icon_legend_orientation
  ...
  if (!is.null(chart_color_legend_show_legend)) {
    if (
      !chart_color_legend_show_legend %in% list_chart_color_legend_show_legend
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_color_legend_show_legend %in% names(named_list)
        ) {
          if (is.logical(chart_color_legend_show_legend)) {
            chart_color_legend_show_legend <- as.character(
  ...
  if (!is.null(chart_color_legend_title_mode)) {
    if (
      !chart_color_legend_title_mode %in% list_chart_color_legend_title_mode
    ) {
      stop(
        "`chart_color_legend_title_mode` must be one of: c('auto', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"auto": "auto", "custom": "custom"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_color_legend_title_mode %in% names(named_list)
        ) {
          if (is.logical(chart_color_legend_title_mode)) {
            chart_color_legend_title_mode <- as.character(
              chart_color_legend_title_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_color_legend_title_mode
  ...
  if (length(chart_color_legend_order_override) > 1) {
    new_list$x$state$color_legend$order_override <- paste(
      chart_color_legend_order_override,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(chart_color_legend_orientation)) {
    if (
      !chart_color_legend_orientation %in% list_chart_color_legend_orientation
    ) {
      stop(
        "`chart_color_legend_orientation` must be one of: c('horizontal', 'vertical')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_color_legend_orientation %in% names(named_list)
        ) {
          if (is.logical(chart_color_legend_orientation)) {
            chart_color_legend_orientation <- as.character(
              chart_color_legend_orientation
            )
          }
          named_list_value <- unname(named_list[
            chart_color_legend_orientation
  ...
  if (!is.null(value_control_visibility)) {
    if (!value_control_visibility %in% list_value_control_visibility) {
      stop(
        "`value_control_visibility` must be one of: c('always', 'editor', 'never')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"always": "always", "editor": "editor", "never": "never"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            value_control_visibility %in% names(named_list)
        ) {
  ...
  list_chart_value_filter_controls_control_type <- c(
    "dropdown",
    "buttons",
    "slider",
    NULL
  ...
  if (!is.null(chart_value_filter_controls_control_type)) {
    if (
      !chart_value_filter_controls_control_type %in%
        list_chart_value_filter_controls_control_type
    ) {
      stop(
        "`chart_value_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_value_filter_controls_control_type %in% names(named_list)
        ) {
          if (is.logical(chart_value_filter_controls_control_type)) {
            chart_value_filter_controls_control_type <- as.character(
              chart_value_filter_controls_control_type
            )
          }
          named_list_value <- unname(named_list[
            chart_value_filter_controls_control_type
  ...
  if (!is.null(chart_value_filter_controls_button_group)) {
    if (
      !chart_value_filter_controls_button_group %in%
        list_chart_value_filter_controls_button_group
    ) {
      stop(
        "`chart_value_filter_controls_button_group` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_value_filter_controls_button_group %in% names(named_list)
        ) {
          if (is.logical(chart_value_filter_controls_button_group)) {
            chart_value_filter_controls_button_group <- as.character(
  ...
  list_chart_value_filter_controls_button_group_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_value_filter_controls_button_group_width_mode)) {
    if (
      !chart_value_filter_controls_button_group_width_mode %in%
        list_chart_value_filter_controls_button_group_width_mode
    ) {
      stop(
        "`chart_value_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_value_filter_controls_button_group_width_mode)) {
            chart_value_filter_controls_button_group_width_mode <- as.character(
              chart_value_filter_controls_button_group_width_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_value_filter_controls_button_group_width_mode
  ...
  list_chart_value_filter_controls_dropdown_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_value_filter_controls_dropdown_width_mode)) {
    if (
      !chart_value_filter_controls_dropdown_width_mode %in%
        list_chart_value_filter_controls_dropdown_width_mode
    ) {
      stop(
        "`chart_value_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_value_filter_controls_dropdown_width_mode)) {
            chart_value_filter_controls_dropdown_width_mode <- as.character(
              chart_value_filter_controls_dropdown_width_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_value_filter_controls_dropdown_width_mode
  ...
  if (!is.null(chart_value_filter_controls_sort)) {
    if (
      !chart_value_filter_controls_sort %in%
        list_chart_value_filter_controls_sort
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_value_filter_controls_sort %in% names(named_list)
        ) {
          if (is.logical(chart_value_filter_controls_sort)) {
            chart_value_filter_controls_sort <- as.character(
              chart_value_filter_controls_sort
            )
          }
          named_list_value <- unname(named_list[
            chart_value_filter_controls_sort
