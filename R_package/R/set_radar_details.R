...
#' @name set_radar_details
#' @param radars_curve Line curve. Choices: linear, cardinal. Flourish type hint: string, defaults to `NULL`
#' @param radars_star Line shape. Choices: `FALSE`, `TRUE`. Flourish type hint: boolean, defaults to `NULL`
#' @param radars_stroke_width Line width. Flourish type hint: number, defaults to `NULL`
#' @param radars_stroke_opacity Line opacity. Flourish type hint: number, defaults to `NULL`
#' @param radars_fill_opacity Fill opacity. Flourish type hint: number, defaults to `NULL`
#' @param radars_star_inner_radius Star inner. The star shapes inner radius, as a percent of the max radius. Flourish type hint: number, defaults to `NULL`
#' @param chart_color_scale_categorical_palette Flourish type hint: colors, defaults to `NULL`
...
#' @param facet_comparisons Show comparison lines in grid mode. Flourish type hint: boolean, defaults to `NULL`
#' @param facet_comparison_stroke Line. Flourish type hint: color, defaults to `NULL`
#' @param facet_comparison_stroke_width Line width. Flourish type hint: number, defaults to `NULL`
#' @param facet_comparison_stroke_opacity Line opacity. Flourish type hint: number, defaults to `NULL`
#' @param facet_comparison_fill Fill. Flourish type hint: color, defaults to `NULL`
#' @param facet_comparison_fill_opacity Fill opacity. Flourish type hint: number, defaults to `NULL`
...
#' @param chart_radial_axis_axis_show Choices: `TRUE`, `FALSE`. Flourish type hint: boolean, defaults to `NULL`
#' @param chart_radial_axis_x_line_color Line. Flourish type hint: color, defaults to `NULL`
#' @param chart_radial_axis_x_line_width Width. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_x_tick_label_color Color. Flourish type hint: color, defaults to `NULL`
#' @param chart_radial_axis_x_tick_label_size Size. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_x_tick_label_outline Outline. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_x_tick_label_weight Choices: 600, 400. Flourish type hint: string, defaults to `NULL`
#' @param chart_radial_axis_y_min Min value. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_y_max Max value. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_y_tick_number Number. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_y_line_color Color. Flourish type hint: color, defaults to `NULL`
#' @param chart_radial_axis_y_line_width Width. Flourish type hint: string, defaults to `NULL`
#' @param chart_radial_axis_y_line_dash Dash. Flourish type hint: string, defaults to `NULL`
#' @param chart_radial_axis_y_line_dash_gap Gap. Flourish type hint: string, defaults to `NULL`
#' @param chart_radial_axis_y_tick_label_color Color. Flourish type hint: color, defaults to `NULL`
#' @param chart_radial_axis_y_tick_label_size Size. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_y_tick_label_outline Outline. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_y_tick_label_space Space. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_y_tick_label_weight Choices: 600, 400. Flourish type hint: string, defaults to `NULL`
#' @param chart_radial_axis_margin_top Top. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_margin_right Right. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_margin_bottom Bottom. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_margin_left Left. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_group_labels Outer labels. Enter one per line, with an angle and a label separated by a colon, such as: 50: My Label. Flourish type hint: text, defaults to `NULL`
#' @param chart_radial_axis_group_labels_color Color. Flourish type hint: color, defaults to `NULL`
#' @param chart_radial_axis_group_labels_size Size. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_group_labels_letter_spacing Letter spacing. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_group_labels_space_above Space above. Flourish type hint: number, defaults to `NULL`
#' @param chart_radial_axis_group_labels_space_below Space below. Flourish type hint: number, defaults to `NULL`
...
#' @param chart_legend_show_legend Legend mode. Choices: `TRUE`, `FALSE`. A legend will not show with a single entry. Flourish type hint: boolean, defaults to `NULL`
...
#' @param facet_control_show Show charts grid control. Flourish type hint: boolean, defaults to `NULL`
#' @param facet_control_default Option to show on load. If you want to specify a different facet view to show on load either make a story or enter the label from the relevant button here. Case sensitive. Flourish type hint: string, defaults to `NULL`
#' @param facet_control_none Include combined option. Flourish type hint: boolean, defaults to `NULL`
#' @param facets_label_combined Combined label. Flourish type hint: string, defaults to `NULL`
#' @param facet_control_individual Include separate option. Flourish type hint: boolean, defaults to `NULL`
#' @param facets_label_separate Separate label. Flourish type hint: string, defaults to `NULL`
#' @param chart_facet_filter_controls_control_type Control type. Choices: dropdown, buttons, slider. Choose between a dropdown, buttons or a  time slider Flourish type hint: string, defaults to `NULL`
#' @param chart_facet_filter_controls_control_styles Adv. Flourish type hint: boolean, defaults to `NULL`
#' @param chart_facet_filter_controls_control_title Control title. Flourish type hint: string, defaults to `NULL`
#' @param chart_facet_filter_controls_button_group Grouped. Choices: `TRUE`, `FALSE`. Flourish type hint: boolean, defaults to `NULL`
#' @param chart_facet_filter_controls_button_group_width_mode Button group width. Choices: auto, full, fixed. Flourish type hint: string, defaults to `NULL`
#' @param chart_facet_filter_controls_button_group_width_fixed Width. Flourish type hint: number, defaults to `NULL`
#' @param chart_facet_filter_controls_dropdown_width_mode Dropdown width. Choices: auto, full, fixed. Flourish type hint: string, defaults to `NULL`
#' @param chart_facet_filter_controls_dropdown_width_fixed Width. Flourish type hint: number, defaults to `NULL`
#' @param chart_facet_filter_controls_slider_width Slider width. Width of the slider track in rems Flourish type hint: number, defaults to `NULL`
#' @param chart_facet_filter_controls_slider_max_label_width Max label width. In rems, multiples of base font size. If larger than the longest label, only the space required to fit labels will be used. Flourish type hint: number, defaults to `NULL`
#' @param chart_facet_filter_controls_slider_step_time Time between steps. Measured in seconds, positive values move the slider left to right, negative values move the slider right to left. Flourish type hint: number, defaults to `NULL`
#' @param chart_facet_filter_controls_slider_loop Loop. Flourish type hint: boolean, defaults to `NULL`
#' @param chart_facet_filter_controls_slider_restart_pause Pause before loop. Measured in seconds and in addition to the regular step time displayed above. Flourish type hint: number, defaults to `NULL`
#' @param chart_facet_filter_controls_sort Sorting. Choices: `TRUE`, `FALSE`. Flourish type hint: boolean, defaults to `NULL`
...
#' @param filter_y_max Update axis y max when filtering. Flourish type hint: boolean, defaults to `NULL`
...
#' @param popup_color_headings Color popup headings. Flourish type hint: boolean, defaults to `NULL`
#' @param duration Duration. The duration, in seconds, of transitions  for example between two slides in a story. Flourish type hint: number, defaults to `NULL`
...
set_radar_details <- function(
  ...
  if (isTRUE(old_list$x$template != "@flourish/radar")) {
    stop("`set_radar_details()` is not supported for this chart type.")
  }
  list_radars_curve <- c("linear", "cardinal", NULL)
  if (!is.null(radars_curve)) {
    if (!radars_curve %in% list_radars_curve) {
      stop("`radars_curve` must be one of: c('linear', 'cardinal')")
    } else {
      if (length(jsonlite::fromJSON('{"linear": "linear", "cardinal": "cardinal"}')) > 1) {
        named_list <- jsonlite::fromJSON('{"linear": "linear", "cardinal": "cardinal"}')
        ...
        if (length(named_list) > 1 && radars_curve %in% names(named_list)) {
          if (is.logical(radars_curve)) {
            radars_curve <- as.character(radars_curve)
          }
          named_list_value <- unname(named_list[radars_curve])[[1]]
          new_list$x$state$radars$curve <- named_list_value
        }
      }
    }
  }
  list_radars_star <- c(FALSE, TRUE, NULL)
  if (!is.null(radars_star)) {
    if (!radars_star %in% list_radars_star) {
      stop("`radars_star` must be one of: c(FALSE, TRUE)")
    } else {
      if (length(jsonlite::fromJSON('{"false": false, "true": true}')) > 1) {
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && radars_star %in% names(named_list)) {
          if (is.logical(radars_star)) {
            radars_star <- as.character(radars_star)
          }
          named_list_value <- unname(named_list[radars_star])[[1]]
          new_list$x$state$radars$star <- named_list_value
        }
      }
    }
  }
  new_list$x$state$radars$stroke_width <- radars_stroke_width
  new_list$x$state$radars$stroke_opacity <- radars_stroke_opacity
  new_list$x$state$radars$fill_opacity <- radars_fill_opacity
  new_list$x$state$radars$star_inner_radius <- radars_star_inner_radius
  ...
  new_list$x$state$facet_comparisons <- facet_comparisons
  new_list$x$state$facet_comparison_stroke <- facet_comparison_stroke
  new_list$x$state$facet_comparison_stroke_width <- facet_comparison_stroke_width
  new_list$x$state$facet_comparison_stroke_opacity <- facet_comparison_stroke_opacity
  new_list$x$state$facet_comparison_fill <- facet_comparison_fill
  new_list$x$state$facet_comparison_fill_opacity <- facet_comparison_fill_opacity
  ...
  list_chart_radial_axis_axis_show <- c(TRUE, FALSE, NULL)
  if (!is.null(chart_radial_axis_axis_show)) {
    if (!chart_radial_axis_axis_show %in% list_chart_radial_axis_axis_show) {
      stop("`chart_radial_axis_axis_show` must be one of: c(TRUE, FALSE)")
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_radial_axis_axis_show %in% names(named_list)) {
          if (is.logical(chart_radial_axis_axis_show)) {
            chart_radial_axis_axis_show <- as.character(chart_radial_axis_axis_show)
          }
          named_list_value <- unname(named_list[chart_radial_axis_axis_show])[[1]]
          new_list$x$state$radial_axis$axis_show <- named_list_value
        }
      }
    }
  }
  new_list$x$state$radial_axis$x_line_color <- chart_radial_axis_x_line_color
  new_list$x$state$radial_axis$x_line_width <- chart_radial_axis_x_line_width
  new_list$x$state$radial_axis$x_tick_label_color <- chart_radial_axis_x_tick_label_color
  new_list$x$state$radial_axis$x_tick_label_size <- chart_radial_axis_x_tick_label_size
  new_list$x$state$radial_axis$x_tick_label_outline <- chart_radial_axis_x_tick_label_outline
  list_chart_radial_axis_x_tick_label_weight <- c("600", "400", NULL)
  if (!is.null(chart_radial_axis_x_tick_label_weight)) {
    if (!chart_radial_axis_x_tick_label_weight %in% list_chart_radial_axis_x_tick_label_weight) {
      stop("`chart_radial_axis_x_tick_label_weight` must be one of: c('600', '400')")
    } else {
      if (length(jsonlite::fromJSON('{"600": "600", "400": "400"}')) > 1) {
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_radial_axis_x_tick_label_weight %in% names(named_list)) {
          if (is.logical(chart_radial_axis_x_tick_label_weight)) {
            chart_radial_axis_x_tick_label_weight <- as.character(chart_radial_axis_x_tick_label_weight)
          }
          named_list_value <- unname(named_list[chart_radial_axis_x_tick_label_weight])[[1]]
          new_list$x$state$radial_axis$x_tick_label_weight <- named_list_value
        }
      }
    }
  }
  new_list$x$state$radial_axis$y_min <- chart_radial_axis_y_min
  new_list$x$state$radial_axis$y_max <- chart_radial_axis_y_max
  new_list$x$state$radial_axis$y_tick_number <- chart_radial_axis_y_tick_number
  new_list$x$state$radial_axis$y_line_color <- chart_radial_axis_y_line_color
  new_list$x$state$radial_axis$y_line_width <- chart_radial_axis_y_line_width
  new_list$x$state$radial_axis$y_line_dash <- chart_radial_axis_y_line_dash
  new_list$x$state$radial_axis$y_line_dash_gap <- chart_radial_axis_y_line_dash_gap
  new_list$x$state$radial_axis$y_tick_label_color <- chart_radial_axis_y_tick_label_color
  new_list$x$state$radial_axis$y_tick_label_size <- chart_radial_axis_y_tick_label_size
  new_list$x$state$radial_axis$y_tick_label_outline <- chart_radial_axis_y_tick_label_outline
  new_list$x$state$radial_axis$y_tick_label_space <- chart_radial_axis_y_tick_label_space
  list_chart_radial_axis_y_tick_label_weight <- c("600", "400", NULL)
  if (!is.null(chart_radial_axis_y_tick_label_weight)) {
    if (!chart_radial_axis_y_tick_label_weight %in% list_chart_radial_axis_y_tick_label_weight) {
      stop("`chart_radial_axis_y_tick_label_weight` must be one of: c('600', '400')")
    } else {
      if (length(jsonlite::fromJSON('{"600": "600", "400": "400"}')) > 1) {
        named_list <- jsonlite::fromJSON('{"600": "600", "400": "400"}')
        # Get the names of the list
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_radial_axis_y_tick_label_weight %in% names(named_list)) {
          if (is.logical(chart_radial_axis_y_tick_label_weight)) {
            chart_radial_axis_y_tick_label_weight <- as.character(chart_radial_axis_y_tick_label_weight)
          }
          named_list_value <- unname(named_list[chart_radial_axis_y_tick_label_weight])[[1]]
          new_list$x$state$radial_axis$y_tick_label_weight <- named_list_value
        }
      }
    }
  }
  new_list$x$state$radial_axis$margin_top <- chart_radial_axis_margin_top
  new_list$x$state$radial_axis$margin_right <- chart_radial_axis_margin_right
  new_list$x$state$radial_axis$margin_bottom <- chart_radial_axis_margin_bottom
  new_list$x$state$radial_axis$margin_left <- chart_radial_axis_margin_left
  if (length(chart_radial_axis_group_labels) > 1) {
    new_list$x$state$radial_axis$group_labels <- paste(chart_radial_axis_group_labels, collapse = "\n")
  } else {
    new_list$x$state$radial_axis$group_labels <- chart_radial_axis_group_labels
  }

  new_list$x$state$radial_axis$group_labels_color <- chart_radial_axis_group_labels_color
  new_list$x$state$radial_axis$group_labels_size <- chart_radial_axis_group_labels_size
  new_list$x$state$radial_axis$group_labels_letter_spacing <- chart_radial_axis_group_labels_letter_spacing
  new_list$x$state$radial_axis$group_labels_space_above <- chart_radial_axis_group_labels_space_above
  new_list$x$state$radial_axis$group_labels_space_below <- chart_radial_axis_group_labels_space_below
  ...
  new_list$x$state$facet_control_show <- facet_control_show
  new_list$x$state$facet_control_default <- facet_control_default
  new_list$x$state$facet_control_none <- facet_control_none
  new_list$x$state$facets_label_combined <- facets_label_combined
  new_list$x$state$facet_control_individual <- facet_control_individual
  new_list$x$state$facets_label_separate <- facets_label_separate
  list_chart_facet_filter_controls_control_type <- c("dropdown", "buttons", "slider", NULL)
  if (!is.null(chart_facet_filter_controls_control_type)) {
    if (!chart_facet_filter_controls_control_type %in% list_chart_facet_filter_controls_control_type) {
      stop("`chart_facet_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')")
    } else {
      if (length(jsonlite::fromJSON('{"dropdown": "dropdown", "buttons": "buttons", "slider": "slider"}')) > 1) {
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_facet_filter_controls_control_type %in% names(named_list)) {
          if (is.logical(chart_facet_filter_controls_control_type)) {
            chart_facet_filter_controls_control_type <- as.character(chart_facet_filter_controls_control_type)
          }
          named_list_value <- unname(named_list[chart_facet_filter_controls_control_type])[[1]]
          new_list$x$state$facets_control$control_type <- named_list_value
        }
      }
    }
  }
  new_list$x$state$facets_control$control_styles <- chart_facet_filter_controls_control_styles
  new_list$x$state$facets_control$control_title <- chart_facet_filter_controls_control_title
  list_chart_facet_filter_controls_button_group <- c(TRUE, FALSE, NULL)
  if (!is.null(chart_facet_filter_controls_button_group)) {
    if (!chart_facet_filter_controls_button_group %in% list_chart_facet_filter_controls_button_group) {
      stop("`chart_facet_filter_controls_button_group` must be one of: c(TRUE, FALSE)")
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        # Get the names of the list
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_facet_filter_controls_button_group %in% names(named_list)) {
          if (is.logical(chart_facet_filter_controls_button_group)) {
            chart_facet_filter_controls_button_group <- as.character(chart_facet_filter_controls_button_group)
          }
          named_list_value <- unname(named_list[chart_facet_filter_controls_button_group])[[1]]
          new_list$x$state$facets_control$button_group <- named_list_value
        }
      }
    }
  }
  list_chart_facet_filter_controls_button_group_width_mode <- c("auto", "full", "fixed", NULL)
  if (!is.null(chart_facet_filter_controls_button_group_width_mode)) {
    if (!chart_facet_filter_controls_button_group_width_mode %in% list_chart_facet_filter_controls_button_group_width_mode) {
      stop("`chart_facet_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')")
    } else {
      if (length(jsonlite::fromJSON('{"auto": "auto", "full": "full", "fixed": "fixed"}')) > 1) {
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_facet_filter_controls_button_group_width_mode %in% names(named_list)) {
          if (is.logical(chart_facet_filter_controls_button_group_width_mode)) {
            chart_facet_filter_controls_button_group_width_mode <- as.character(chart_facet_filter_controls_button_group_width_mode)
          }
          named_list_value <- unname(named_list[chart_facet_filter_controls_button_group_width_mode])[[1]]
          new_list$x$state$facets_control$button_group_width_mode <- named_list_value
        }
      }
    }
  }
  new_list$x$state$facets_control$button_group_width_fixed <- chart_facet_filter_controls_button_group_width_fixed
  list_chart_facet_filter_controls_dropdown_width_mode <- c("auto", "full", "fixed", NULL)
  if (!is.null(chart_facet_filter_controls_dropdown_width_mode)) {
    if (!chart_facet_filter_controls_dropdown_width_mode %in% list_chart_facet_filter_controls_dropdown_width_mode) {
      stop("`chart_facet_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')")
    } else {
      if (length(jsonlite::fromJSON('{"auto": "auto", "full": "full", "fixed": "fixed"}')) > 1) {
        named_list <- jsonlite::fromJSON('{"auto": "auto", "full": "full", "fixed": "fixed"}')
        # Get the names of the list
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_facet_filter_controls_dropdown_width_mode %in% names(named_list)) {
          if (is.logical(chart_facet_filter_controls_dropdown_width_mode)) {
            chart_facet_filter_controls_dropdown_width_mode <- as.character(chart_facet_filter_controls_dropdown_width_mode)
          }
          named_list_value <- unname(named_list[chart_facet_filter_controls_dropdown_width_mode])[[1]]
          new_list$x$state$facets_control$dropdown_width_mode <- named_list_value
        }
      }
    }
  }
  new_list$x$state$facets_control$dropdown_width_fixed <- chart_facet_filter_controls_dropdown_width_fixed
  new_list$x$state$facets_control$slider_width <- chart_facet_filter_controls_slider_width
  ...
  new_list$x$state$facets_control$slider_loop <- chart_facet_filter_controls_slider_loop
  new_list$x$state$facets_control$slider_restart_pause <- chart_facet_filter_controls_slider_restart_pause
  list_chart_facet_filter_controls_sort <- c(TRUE, FALSE, NULL)
  if (!is.null(chart_facet_filter_controls_sort)) {
    if (!chart_facet_filter_controls_sort %in% list_chart_facet_filter_controls_sort) {
      stop("`chart_facet_filter_controls_sort` must be one of: c(TRUE, FALSE)")
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        # Get the names of the list
        ...
        # Set the names of the list to boolean values
        names(named_list) <- boolean_names
        if (length(named_list) > 1 && chart_facet_filter_controls_sort %in% names(named_list)) {
          if (is.logical(chart_facet_filter_controls_sort)) {
            chart_facet_filter_controls_sort <- as.character(chart_facet_filter_controls_sort)
          }
          named_list_value <- unname(named_list[chart_facet_filter_controls_sort])[[1]]
          new_list$x$state$facets_control$sort <- named_list_value
        }
      }
    }
  }
  ...
  new_list$x$state$filter_y_max <- filter_y_max
  ...
  new_list$x$state$popup_color_headings <- popup_color_headings
