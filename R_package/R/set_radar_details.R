...
set_radar_details <- function(
    ...
    if (!radars_curve %in% list_radars_curve) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"linear": "linear", "cardinal": "cardinal"}'
        )) >
          1
      ) {
  ...
  if (!is.null(chart_radial_axis_axis_show)) {
    if (!chart_radial_axis_axis_show %in% list_chart_radial_axis_axis_show) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_radial_axis_axis_show %in% names(named_list)
        ) {
          if (is.logical(chart_radial_axis_axis_show)) {
            chart_radial_axis_axis_show <- as.character(
              chart_radial_axis_axis_show
            )
          }
          named_list_value <- unname(named_list[chart_radial_axis_axis_show])[[
            1
          ]]
  ...
  if (!is.null(chart_radial_axis_x_tick_label_weight)) {
    if (
      !chart_radial_axis_x_tick_label_weight %in%
        list_chart_radial_axis_x_tick_label_weight
    ) {
      stop(
        "`chart_radial_axis_x_tick_label_weight` must be one of: c('600', '400')"
      )
    } else {
      if (length(jsonlite::fromJSON('{"600": "600", "400": "400"}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_radial_axis_x_tick_label_weight %in% names(named_list)
        ) {
          if (is.logical(chart_radial_axis_x_tick_label_weight)) {
            chart_radial_axis_x_tick_label_weight <- as.character(
              chart_radial_axis_x_tick_label_weight
            )
          }
          named_list_value <- unname(named_list[
            chart_radial_axis_x_tick_label_weight
  ...
  if (!is.null(chart_radial_axis_y_tick_label_weight)) {
    if (
      !chart_radial_axis_y_tick_label_weight %in%
        list_chart_radial_axis_y_tick_label_weight
    ) {
      stop(
        "`chart_radial_axis_y_tick_label_weight` must be one of: c('600', '400')"
      )
    } else {
      if (length(jsonlite::fromJSON('{"600": "600", "400": "400"}')) > 1) {
        named_list <- jsonlite::fromJSON('{"600": "600", "400": "400"}')
        ...
        if (
          length(named_list) > 1 &&
            chart_radial_axis_y_tick_label_weight %in% names(named_list)
        ) {
          if (is.logical(chart_radial_axis_y_tick_label_weight)) {
            chart_radial_axis_y_tick_label_weight <- as.character(
              chart_radial_axis_y_tick_label_weight
            )
          }
          named_list_value <- unname(named_list[
            chart_radial_axis_y_tick_label_weight
  ...
  if (length(chart_radial_axis_group_labels) > 1) {
    new_list$x$state$radial_axis$group_labels <- paste(
      chart_radial_axis_group_labels,
      collapse = "\n"
    )
  } else {
  ...
  if (!is.null(chart_legend_show_legend)) {
    if (!chart_legend_show_legend %in% list_chart_legend_show_legend) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_legend_show_legend %in% names(named_list)
        ) {
  ...
  if (!is.null(chart_legend_title_mode)) {
    if (!chart_legend_title_mode %in% list_chart_legend_title_mode) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            chart_legend_title_mode %in% names(named_list)
        ) {
  ...
  if (length(chart_legend_order_override) > 1) {
    new_list$x$state$legend$order_override <- paste(
  ...
  if (!is.null(chart_legend_orientation)) {
    if (!chart_legend_orientation %in% list_chart_legend_orientation) {
      stop(
        "`chart_legend_orientation` must be one of: c('horizontal', 'vertical')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_legend_orientation %in% names(named_list)
        ) {
  ...
  list_chart_facet_filter_controls_control_type <- c(
    "dropdown",
    "buttons",
    "slider",
    NULL
  ...
  if (!is.null(chart_facet_filter_controls_control_type)) {
    if (
      !chart_facet_filter_controls_control_type %in%
        list_chart_facet_filter_controls_control_type
    ) {
      stop(
        "`chart_facet_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_facet_filter_controls_control_type %in% names(named_list)
        ) {
          if (is.logical(chart_facet_filter_controls_control_type)) {
            chart_facet_filter_controls_control_type <- as.character(
              chart_facet_filter_controls_control_type
            )
          }
          named_list_value <- unname(named_list[
            chart_facet_filter_controls_control_type
  ...
  if (!is.null(chart_facet_filter_controls_button_group)) {
    if (
      !chart_facet_filter_controls_button_group %in%
        list_chart_facet_filter_controls_button_group
    ) {
      stop(
        "`chart_facet_filter_controls_button_group` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_facet_filter_controls_button_group %in% names(named_list)
        ) {
          if (is.logical(chart_facet_filter_controls_button_group)) {
            chart_facet_filter_controls_button_group <- as.character(
              chart_facet_filter_controls_button_group
            )
          }
          named_list_value <- unname(named_list[
            chart_facet_filter_controls_button_group
  ...
  list_chart_facet_filter_controls_button_group_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_facet_filter_controls_button_group_width_mode)) {
    if (
      !chart_facet_filter_controls_button_group_width_mode %in%
        list_chart_facet_filter_controls_button_group_width_mode
    ) {
      stop(
        "`chart_facet_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_facet_filter_controls_button_group_width_mode)) {
            chart_facet_filter_controls_button_group_width_mode <- as.character(
              chart_facet_filter_controls_button_group_width_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_facet_filter_controls_button_group_width_mode
  ...
  list_chart_facet_filter_controls_dropdown_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_facet_filter_controls_dropdown_width_mode)) {
    if (
      !chart_facet_filter_controls_dropdown_width_mode %in%
        list_chart_facet_filter_controls_dropdown_width_mode
    ) {
      stop(
        "`chart_facet_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_facet_filter_controls_dropdown_width_mode)) {
            chart_facet_filter_controls_dropdown_width_mode <- as.character(
  ...
  if (!is.null(chart_facet_filter_controls_sort)) {
    if (
      !chart_facet_filter_controls_sort %in%
        list_chart_facet_filter_controls_sort
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_facet_filter_controls_sort %in% names(named_list)
        ) {
          if (is.logical(chart_facet_filter_controls_sort)) {
            chart_facet_filter_controls_sort <- as.character(
              chart_facet_filter_controls_sort
            )
          }
          named_list_value <- unname(named_list[
            chart_facet_filter_controls_sort
