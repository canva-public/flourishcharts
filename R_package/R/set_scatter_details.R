...
set_scatter_details <- function(
  ...
  if (!is.null(default_shape)) {
    if (!default_shape %in% list_default_shape) {
      stop(
        "`default_shape` must be one of: c('circle', 'cross', 'diamond', 'square', 'star', 'triangle', 'wye')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"circle": "symbolCircle", "cross": "symbolCross", "diamond": "symbolDiamond", "square": "symbolSquare", "star": "symbolStar", "triangle": "symbolTriangle", "wye": "symbolWye"}'
        )) >
          1
      ) {
  ...
  if (!is.null(label_color_type)) {
    if (!label_color_type %in% list_label_color_type) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "match": "match", "fixed": "fixed"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(labels_responsive)) {
    if (!labels_responsive %in% list_labels_responsive) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"chart": "chart", "data": "data", "none": "none"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && labels_responsive %in% names(named_list)
        ) {
  ...
  if (!is.null(label_align)) {
    if (!label_align %in% list_label_align) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "start": "start", "middle": "middle", "end": "end"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(label_y_offset)) {
    if (!label_y_offset %in% list_label_y_offset) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"top": "top", "above": "above", "below": "below"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(facet_title_align)) {
    if (!facet_title_align %in% list_facet_title_align) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && facet_title_align %in% names(named_list)
        ) {
  ...
  if (!is.null(line_curve)) {
    if (!line_curve %in% list_line_curve) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"curve_linear": "curveLinear", "curve_natural": "curveNatural"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(line_color_mode)) {
    if (!line_color_mode %in% list_line_color_mode) {
      ...
      if (
        length(jsonlite::fromJSON('{"by_dot": "by_dot", "fixed": "fixed"}')) > 1
      ) {
        named_list <- jsonlite::fromJSON(
          '{"by_dot": "by_dot", "fixed": "fixed"}'
        )
        # Get the names of the list
        names_list <- names(named_list)
        # Convert names to boolean values only if they are "true" or "false"
  ...
  if (!is.null(line_arrow_color_mode)) {
    if (!line_arrow_color_mode %in% list_line_arrow_color_mode) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && line_arrow_color_mode %in% names(named_list)
        ) {
  ...
  if (!is.null(legend_position)) {
    if (!legend_position %in% list_legend_position) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"above": "above", "below": "below", "off": "off"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(legend_filtering_mode)) {
    if (!legend_filtering_mode %in% list_legend_filtering_mode) {
      stop(
        "`legend_filtering_mode` must be one of: c('filter_out', 'filter_in', 'off')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"filter_out": "filter_out", "filter_in": "filter_in", "off": "off"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && legend_filtering_mode %in% names(named_list)
        ) {
  ...
  if (length(chart_categorical_legend_order_override) > 1) {
    new_list$x$state$categorical_legend$order_override <- paste(
  ...
  if (!is.null(chart_continous_legend_show_legend)) {
    if (
      !chart_continous_legend_show_legend %in%
        list_chart_continous_legend_show_legend
    ) {
      stop(
        "`chart_continous_legend_show_legend` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_continous_legend_show_legend %in% names(named_list)
        ) {
          if (is.logical(chart_continous_legend_show_legend)) {
            chart_continous_legend_show_legend <- as.character(
              chart_continous_legend_show_legend
            )
          }
          named_list_value <- unname(named_list[
            chart_continous_legend_show_legend
  ...
  if (!is.null(chart_continous_legend_title_mode)) {
    if (
      !chart_continous_legend_title_mode %in%
        list_chart_continous_legend_title_mode
    ) {
      stop(
        "`chart_continous_legend_title_mode` must be one of: c('auto', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON('{"auto": "auto", "custom": "custom"}')) > 1
        ...
        if (
          length(named_list) > 1 &&
            chart_continous_legend_title_mode %in% names(named_list)
        ) {
          if (is.logical(chart_continous_legend_title_mode)) {
            chart_continous_legend_title_mode <- as.character(
              chart_continous_legend_title_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_continous_legend_title_mode
  ...
  list_chart_continous_legend_binned_label_mode <- c(
    "thresholds",
    "centers",
    "custom",
    NULL
  ...
  if (!is.null(chart_continous_legend_binned_label_mode)) {
    if (
      !chart_continous_legend_binned_label_mode %in%
        list_chart_continous_legend_binned_label_mode
    ) {
      stop(
        "`chart_continous_legend_binned_label_mode` must be one of: c('thresholds', 'centers', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"thresholds": "thresholds", "centers": "centers", "custom": "custom"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_continous_legend_binned_label_mode %in% names(named_list)
        ) {
          if (is.logical(chart_continous_legend_binned_label_mode)) {
            chart_continous_legend_binned_label_mode <- as.character(
              chart_continous_legend_binned_label_mode
            )
          }
          named_list_value <- unname(named_list[
            chart_continous_legend_binned_label_mode
  ...
  if (!is.null(filter_updates_axes)) {
    if (!filter_updates_axes %in% list_filter_updates_axes) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && filter_updates_axes %in% names(named_list)
        ) {
  ...
  if (!is.null(slider_updates_axes)) {
    if (!slider_updates_axes %in% list_slider_updates_axes) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && slider_updates_axes %in% names(named_list)
        ) {
  ...
  list_chart_slider_filter_controls_control_type <- c(
    "dropdown",
    "buttons",
    "slider",
    NULL
  ...
  if (!is.null(chart_slider_filter_controls_control_type)) {
    if (
      !chart_slider_filter_controls_control_type %in%
        list_chart_slider_filter_controls_control_type
    ) {
      stop(
        "`chart_slider_filter_controls_control_type` must be one of: c('dropdown', 'buttons', 'slider')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            chart_slider_filter_controls_control_type %in% names(named_list)
        ) {
          if (is.logical(chart_slider_filter_controls_control_type)) {
            chart_slider_filter_controls_control_type <- as.character(
              chart_slider_filter_controls_control_type
            )
          }
          named_list_value <- unname(named_list[
            chart_slider_filter_controls_control_type
  ...
  if (!is.null(chart_slider_filter_controls_button_group)) {
    if (
      !chart_slider_filter_controls_button_group %in%
        list_chart_slider_filter_controls_button_group
    ) {
      stop(
        "`chart_slider_filter_controls_button_group` must be one of: c(TRUE, FALSE)"
      )
    } else {
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        named_list <- jsonlite::fromJSON('{"true": true, "false": false}')
        ...
        if (
          length(named_list) > 1 &&
            chart_slider_filter_controls_button_group %in% names(named_list)
        ) {
          if (is.logical(chart_slider_filter_controls_button_group)) {
            chart_slider_filter_controls_button_group <- as.character(
  ...
  list_chart_slider_filter_controls_button_group_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_slider_filter_controls_button_group_width_mode)) {
    if (
      !chart_slider_filter_controls_button_group_width_mode %in%
        list_chart_slider_filter_controls_button_group_width_mode
    ) {
      stop(
        "`chart_slider_filter_controls_button_group_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (
            is.logical(chart_slider_filter_controls_button_group_width_mode)
          ) {
            chart_slider_filter_controls_button_group_width_mode <- as.character(
  ...
  list_chart_slider_filter_controls_dropdown_width_mode <- c(
    "auto",
    "full",
    "fixed",
    NULL
  ...
  if (!is.null(chart_slider_filter_controls_dropdown_width_mode)) {
    if (
      !chart_slider_filter_controls_dropdown_width_mode %in%
        list_chart_slider_filter_controls_dropdown_width_mode
    ) {
      stop(
        "`chart_slider_filter_controls_dropdown_width_mode` must be one of: c('auto', 'full', 'fixed')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          ...
          if (is.logical(chart_slider_filter_controls_dropdown_width_mode)) {
            chart_slider_filter_controls_dropdown_width_mode <- as.character(
  ...
  if (!is.null(chart_slider_filter_controls_sort)) {
    if (
      !chart_slider_filter_controls_sort %in%
        list_chart_slider_filter_controls_sort
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            chart_slider_filter_controls_sort %in% names(named_list)
        ) {
          if (is.logical(chart_slider_filter_controls_sort)) {
            chart_slider_filter_controls_sort <- as.character(
              chart_slider_filter_controls_sort
            )
          }
          named_list_value <- unname(named_list[
            chart_slider_filter_controls_sort
  ...
  if (!is.null(fit_type)) {
    if (!fit_type %in% list_fit_type) {
      stop(
        "`fit_type` must be one of: c('none', 'both', 'color', 'chart', 'all')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"none": "none", "both": "both", "color": "color", "chart": "chart", "all": "all"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(violin_sizing)) {
    if (!violin_sizing %in% list_violin_sizing) {
      ...
      if (
        length(jsonlite::fromJSON('{"area": "area", "width": "width"}')) > 1
      ) {
