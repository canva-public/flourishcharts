...
set_table_details <- function(
  ...
  if (length(sorting_custom_columns) > 1) {
    new_list$x$state$sorting$custom_columns <- paste(
  ...
  if (!is.null(cell_horizontal_alignment)) {
    if (!cell_horizontal_alignment %in% list_cell_horizontal_alignment) {
      stop(
        "`cell_horizontal_alignment` must be one of: c('start', 'center', 'end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            cell_horizontal_alignment %in% names(named_list)
        ) {
  ...
  if (!is.null(cell_numeric_horizontal_alignment)) {
    if (
      !cell_numeric_horizontal_alignment %in%
        list_cell_numeric_horizontal_alignment
    ) {
      stop(
        "`cell_numeric_horizontal_alignment` must be one of: c('start', 'center', 'end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            cell_numeric_horizontal_alignment %in% names(named_list)
        ) {
          if (is.logical(cell_numeric_horizontal_alignment)) {
            cell_numeric_horizontal_alignment <- as.character(
  ...
  if (!is.null(cell_vertical_alignment)) {
    if (!cell_vertical_alignment %in% list_cell_vertical_alignment) {
      stop(
        "`cell_vertical_alignment` must be one of: c('top', 'center', 'bottom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            cell_vertical_alignment %in% names(named_list)
        ) {
  ...
  if (!is.null(cell_fill_direction)) {
    if (!cell_fill_direction %in% list_cell_fill_direction) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && cell_fill_direction %in% names(named_list)
        ) {
  ...
  if (length(cell_fill_custom_categorical) > 1) {
    new_list$x$state$cell_fill_custom_categorical <- paste(
  ...
  if (length(cell_fill_custom_numeric) > 1) {
    new_list$x$state$cell_fill_custom_numeric <- paste(
  ...
  if (!is.null(cell_border_mode)) {
    if (!cell_border_mode %in% list_cell_border_mode) {
      stop(
        "`cell_border_mode` must be one of: c('none', 'horizontal', 'vertical', 'both')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
  ...
  if (!is.null(cell_border_style)) {
    if (!cell_border_style %in% list_cell_border_style) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && cell_border_style %in% names(named_list)
        ) {
  ...
  if (!is.null(cell_font_size)) {
    if (!cell_font_size %in% list_cell_font_size) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"1": "1", "1.25": "1.25", "1.5": "1.5", "custom": "custom"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(column_width_mode)) {
    if (!column_width_mode %in% list_column_width_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"auto": "auto", "equal": "equal", "fixed": "fixed"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && column_width_mode %in% names(named_list)
        ) {
  ...
  if (!is.null(header_font_weight)) {
    if (!header_font_weight %in% list_header_font_weight) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && header_font_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(header_style_default)) {
    if (!header_style_default %in% list_header_style_default) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && header_style_default %in% names(named_list)
        ) {
  ...
  if (!is.null(header_horizontal_alignment)) {
    if (!header_horizontal_alignment %in% list_header_horizontal_alignment) {
      stop(
        "`header_horizontal_alignment` must be one of: c('start', 'center', 'end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            header_horizontal_alignment %in% names(named_list)
        ) {
          if (is.logical(header_horizontal_alignment)) {
            header_horizontal_alignment <- as.character(
              header_horizontal_alignment
            )
          }
          named_list_value <- unname(named_list[header_horizontal_alignment])[[
            1
          ]]
  ...
  if (!is.null(header_font_default)) {
    if (!header_font_default %in% list_header_font_default) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && header_font_default %in% names(named_list)
        ) {
  ...
  if (!is.null(header_border_default)) {
    if (!header_border_default %in% list_header_border_default) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && header_border_default %in% names(named_list)
        ) {
  ...
  if (!is.null(header_border_style)) {
    if (!header_border_style %in% list_header_border_style) {
      stop(
        "`header_border_style` must be one of: c('solid', 'dashed', 'dotted')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && header_border_style %in% names(named_list)
        ) {
  ...
  if (!is.null(bar_columns_enabled)) {
    if (!bar_columns_enabled %in% list_bar_columns_enabled) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && bar_columns_enabled %in% names(named_list)
        ) {
  ...
  if (length(bar_columns_bar_1_columns) > 1) {
    new_list$x$state$bar_columns$bar_1_columns <- paste(
  ...
  if (!is.null(bar_columns_type)) {
    if (!bar_columns_type %in% list_bar_columns_type) {
      ...
      if (
        length(jsonlite::fromJSON('{"bars": "bars", "columns": "columns"}')) > 1
      ) {
        named_list <- jsonlite::fromJSON(
          '{"bars": "bars", "columns": "columns"}'
        )
        # Get the names of the list
        names_list <- names(named_list)
        # Convert names to boolean values only if they are "true" or "false"
  ...
  if (!is.null(bar_columns_bar_1_proportional)) {
    if (
      !bar_columns_bar_1_proportional %in% list_bar_columns_bar_1_proportional
    ) {
      ...
      if (length(jsonlite::fromJSON('{"false": false, "true": true}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            bar_columns_bar_1_proportional %in% names(named_list)
        ) {
          if (is.logical(bar_columns_bar_1_proportional)) {
            bar_columns_bar_1_proportional <- as.character(
  ...
  if (!is.null(bar_columns_bar_1_labels)) {
    if (!bar_columns_bar_1_labels %in% list_bar_columns_bar_1_labels) {
      stop(
        "`bar_columns_bar_1_labels` must be one of: c('none', 'popup', 'inline')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"none": "none", "popup": "popup", "inline": "inline"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            bar_columns_bar_1_labels %in% names(named_list)
        ) {
  ...
  if (!is.null(line_columns_enabled)) {
    if (!line_columns_enabled %in% list_line_columns_enabled) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && line_columns_enabled %in% names(named_list)
        ) {
  ...
  if (length(line_columns_line_1_columns) > 1) {
    new_list$x$state$line_columns$line_1_columns <- paste(
  ...
  if (!is.null(line_columns_line_1_area)) {
    if (!line_columns_line_1_area %in% list_line_columns_line_1_area) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            line_columns_line_1_area %in% names(named_list)
        ) {
  ...
  if (!is.null(line_columns_line_1_min_enabled)) {
    if (
      !line_columns_line_1_min_enabled %in% list_line_columns_line_1_min_enabled
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            line_columns_line_1_min_enabled %in% names(named_list)
        ) {
          if (is.logical(line_columns_line_1_min_enabled)) {
            line_columns_line_1_min_enabled <- as.character(
  ...
  if (!is.null(line_columns_line_1_max_enabled)) {
    if (
      !line_columns_line_1_max_enabled %in% list_line_columns_line_1_max_enabled
    ) {
      ...
      if (length(jsonlite::fromJSON('{"true": true, "false": false}')) > 1) {
        ...
        if (
          length(named_list) > 1 &&
            line_columns_line_1_max_enabled %in% names(named_list)
        ) {
          if (is.logical(line_columns_line_1_max_enabled)) {
            line_columns_line_1_max_enabled <- as.character(
  ...
  if (!is.null(mobile_cell_font_size)) {
    if (!mobile_cell_font_size %in% list_mobile_cell_font_size) {
      stop(
        "`mobile_cell_font_size` must be one of: c('1', '1.25', '1.5', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && mobile_cell_font_size %in% names(named_list)
        ) {
  ...
  if (!is.null(search_mode)) {
    if (!search_mode %in% list_search_mode) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"anywhere": "anywhere", "start": "start", "whole": "whole"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(search_columns)) {
    if (!search_columns %in% list_search_columns) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"all": "all", "first": "first", "custom": "custom"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (length(search_columns_custom) > 1) {
    new_list$x$state$search_columns_custom <- paste(
  ...
  if (length(formatted_columns) > 1) {
    new_list$x$state$formatted_columns <- paste(
      formatted_columns,
      collapse = "\n"
    )
  } else {
