...
set_timeline_details <- function(
  ...
  if (!is.null(widescreen_orientation)) {
    if (!widescreen_orientation %in% list_widescreen_orientation) {
      stop(
        "`widescreen_orientation` must be one of: c('horizontal', 'vertical')"
      )
    } else {
      if (
        ...
        if (
          length(named_list) > 1 &&
            widescreen_orientation %in% names(named_list)
        ) {
  ...
  if (!is.null(facet_aspect_mobile)) {
    if (!facet_aspect_mobile %in% list_facet_aspect_mobile) {
      stop(
        "`facet_aspect_mobile` must be one of: c('0.75', '1', '1.5', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && facet_aspect_mobile %in% names(named_list)
        ) {
  ...
  if (!is.null(events_scale_type)) {
    if (!events_scale_type %in% list_events_scale_type) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"linear": "linear", "timescale": "timescale"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && events_scale_type %in% names(named_list)
        ) {
  ...
  if (!is.null(background_sizing)) {
    if (!background_sizing %in% list_background_sizing) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && background_sizing %in% names(named_list)
        ) {
  ...
  if (!is.null(marker_background_color)) {
    if (!marker_background_color %in% list_marker_background_color) {
      ...
      if (
        length(jsonlite::fromJSON('{"data": "data", "custom": "custom"}')) > 1
      ) {
        ...
        if (
          length(named_list) > 1 &&
            marker_background_color %in% names(named_list)
        ) {
  ...
  if (!is.null(marker_border_color)) {
    if (!marker_border_color %in% list_marker_border_color) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && marker_border_color %in% names(named_list)
        ) {
  ...
  if (!is.null(content_border_color)) {
    if (!content_border_color %in% list_content_border_color) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_border_color %in% names(named_list)
        ) {
  ...
  if (!is.null(content_border_top_color)) {
    if (!content_border_top_color %in% list_content_border_top_color) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            content_border_top_color %in% names(named_list)
        ) {
  ...
  if (!is.null(content_border_right_color)) {
    if (!content_border_right_color %in% list_content_border_right_color) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            content_border_right_color %in% names(named_list)
        ) {
          if (is.logical(content_border_right_color)) {
            content_border_right_color <- as.character(
              content_border_right_color
            )
          }
          named_list_value <- unname(named_list[content_border_right_color])[[
            1
          ]]
  ...
  if (!is.null(content_border_bottom_color)) {
    if (!content_border_bottom_color %in% list_content_border_bottom_color) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            content_border_bottom_color %in% names(named_list)
        ) {
          if (is.logical(content_border_bottom_color)) {
            content_border_bottom_color <- as.character(
              content_border_bottom_color
            )
          }
          named_list_value <- unname(named_list[content_border_bottom_color])[[
            1
          ]]
  ...
  if (!is.null(content_border_left_color)) {
    if (!content_border_left_color %in% list_content_border_left_color) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            content_border_left_color %in% names(named_list)
        ) {
  ...
  if (!is.null(content_title_alignment)) {
    if (!content_title_alignment %in% list_content_title_alignment) {
      stop(
        "`content_title_alignment` must be one of: c('start', 'center', 'end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            content_title_alignment %in% names(named_list)
        ) {
  ...
  if (!is.null(content_title_size)) {
    if (!content_title_size %in% list_content_title_size) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_title_size %in% names(named_list)
        ) {
  ...
  if (!is.null(content_title_weight)) {
    if (!content_title_weight %in% list_content_title_weight) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_title_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(content_title_color)) {
    if (!content_title_color %in% list_content_title_color) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_title_color %in% names(named_list)
        ) {
  ...
  if (!is.null(content_title_space_above)) {
    if (!content_title_space_above %in% list_content_title_space_above) {
      stop(
        "`content_title_space_above` must be one of: c('0', '0.5', '1', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            content_title_space_above %in% names(named_list)
        ) {
  ...
  if (!is.null(content_subtitle_alignment)) {
    if (!content_subtitle_alignment %in% list_content_subtitle_alignment) {
      stop(
        "`content_subtitle_alignment` must be one of: c('start', 'center', 'end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            content_subtitle_alignment %in% names(named_list)
        ) {
          if (is.logical(content_subtitle_alignment)) {
            content_subtitle_alignment <- as.character(
              content_subtitle_alignment
            )
          }
          named_list_value <- unname(named_list[content_subtitle_alignment])[[
            1
          ]]
  ...
  if (!is.null(content_subtitle_size)) {
    if (!content_subtitle_size %in% list_content_subtitle_size) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_subtitle_size %in% names(named_list)
        ) {
  ...
  if (!is.null(content_subtitle_weight)) {
    if (!content_subtitle_weight %in% list_content_subtitle_weight) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            content_subtitle_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(content_subtitle_color)) {
    if (!content_subtitle_color %in% list_content_subtitle_color) {
      ...
      if (
        ...
        if (
          length(named_list) > 1 &&
            content_subtitle_color %in% names(named_list)
        ) {
  ...
  if (!is.null(content_subtitle_space_above)) {
    if (!content_subtitle_space_above %in% list_content_subtitle_space_above) {
      stop(
        "`content_subtitle_space_above` must be one of: c('0', '0.5', '1', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            content_subtitle_space_above %in% names(named_list)
        ) {
          if (is.logical(content_subtitle_space_above)) {
            content_subtitle_space_above <- as.character(
              content_subtitle_space_above
            )
          }
          named_list_value <- unname(named_list[content_subtitle_space_above])[[
            1
          ]]
  ...
  if (!is.null(content_text_alignment)) {
    if (!content_text_alignment %in% list_content_text_alignment) {
      stop(
        "`content_text_alignment` must be one of: c('start', 'center', 'end')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            content_text_alignment %in% names(named_list)
        ) {
  ...
  if (!is.null(content_text_size)) {
    if (!content_text_size %in% list_content_text_size) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_text_size %in% names(named_list)
        ) {
  ...
  if (!is.null(content_text_weight)) {
    if (!content_text_weight %in% list_content_text_weight) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_text_weight %in% names(named_list)
        ) {
  ...
  if (!is.null(content_text_color)) {
    if (!content_text_color %in% list_content_text_color) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_text_color %in% names(named_list)
        ) {
  ...
  if (!is.null(content_text_space_above)) {
    if (!content_text_space_above %in% list_content_text_space_above) {
      stop(
        "`content_text_space_above` must be one of: c('0', '0.5', '1', 'custom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        if (
          length(named_list) > 1 &&
            content_text_space_above %in% names(named_list)
        ) {
  ...
  if (!is.null(image_location)) {
    if (!image_location %in% list_image_location) {
      ...
      if (
        length(jsonlite::fromJSON(
          '{"none": "none", "marker": "marker", "content": "content"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(image_display)) {
    if (!image_display %in% list_image_display) {
      stop(
        "`image_display` must be one of: c('float', 'inline', 'banner', 'background')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"float": "float", "inline": "inline", "banner": "banner", "background": "background"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
  ...
  if (!is.null(image_content_sizing)) {
    if (!image_content_sizing %in% list_image_content_sizing) {
      stop(
        "`image_content_sizing` must be one of: c('contain', 'cover', 'zoom')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && image_content_sizing %in% names(named_list)
        ) {
  ...
  if (!is.null(image_float_position)) {
    if (!image_float_position %in% list_image_float_position) {
      ...
      if (length(jsonlite::fromJSON('{"1": "1", "2": "2"}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && image_float_position %in% names(named_list)
        ) {
  ...
  if (!is.null(image_inline_position)) {
    if (!image_inline_position %in% list_image_inline_position) {
      ...
      if (length(jsonlite::fromJSON('{"1": "1", "2": "2", "3": "3"}')) > 1) {
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && image_inline_position %in% names(named_list)
        ) {
  ...
  if (!is.null(content_banner_depth)) {
    if (!content_banner_depth %in% list_content_banner_depth) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && content_banner_depth %in% names(named_list)
        ) {
  ...
  if (!is.null(navigation_step_type)) {
    if (!navigation_step_type %in% list_navigation_step_type) {
      ...
      if (
        length(jsonlite::fromJSON('{"screen": "screen", "event": "event"}')) > 1
      ) {
        named_list <- jsonlite::fromJSON(
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && navigation_step_type %in% names(named_list)
        ) {
  ...
  if (!is.null(navigation_icon_type)) {
    if (!navigation_icon_type %in% list_navigation_icon_type) {
      ...
      if (
        ...
        names(named_list) <- boolean_names
        if (
          length(named_list) > 1 && navigation_icon_type %in% names(named_list)
        ) {
  ...
  if (!is.null(chart_x_axis_axis_position)) {
    if (!chart_x_axis_axis_position %in% list_chart_x_axis_axis_position) {
      stop(
        "`chart_x_axis_axis_position` must be one of: c('bottom', 'top', 'hidden')"
      )
    } else {
      if (
        length(jsonlite::fromJSON(
          '{"bottom": "bottom", "top": "top", "hidden": "hidden"}'
        )) >
          1
      ) {
        named_list <- jsonlite::fromJSON(
