...
flourish_api_documentation_raw <- read.csv(
  "../python_package/flourishcharts/data/flourish_api_documentation.csv"
)
flourish_api_documentation <- flourish_api_documentation_raw[c(
  "template_name",
  "chart_type",
  "url"
)]
...
templates_private <- flourish_api_documentation_raw[c(
  "template_name",
  "template_id",
  "template_version",
  "chart_type"
