...
The following fixes were contributed by @zmeers via [PR #14](https://github.com/canva-public/flourishcharts/pull/14):

- **R package**: Fixed `flourish-live.yaml` referencing wrong JS script name (fixes [#7](https://github.com/canva-public/flourishcharts/issues/7), [#10](https://github.com/canva-public/flourishcharts/issues/10))
- **Both packages**: Added snapshot functionality using the [Flourish snapshot API](https://developers.flourish.studio/api/create-visualisation/#how-to-generate-an-image-of-your-visualization)
- **Both packages**: Fixed hierarchy chart types (`radialtree` → `radialTree`, `circlepacking` → `circlePacking`) camelCase issues
